    ...
    (e) => {
        ...
        async function h(e, r, a) {
            ...
            let y = { ...m, ...e.header },
                ...
                f = !0;
            if (w.has('b64') && 'boolean' != typeof (f = m.b64))
                throw new o.JWSInvalid(
            ...
            let S = !1;
            ('function' == typeof r && ((r = await r(m, e)), (S = !0)),
            ...
            let H = await (0, p.normalizeKey)(r, g);
            if (!(await i(g, H, n, b)))
    ...
    (e) => {
        ...
        async function T(e, { params: t }) {
            try {
                ...
                let l = await S.prisma.appointment.findFirst({
                    where: {
                        id: d,
                        companyId: o,
                        clientId: i.sub,
                ...
                let c =
                        ((r = l.service?.cancelLimitHours),
                        (n = 'number' == typeof r ? r : Number(r)),
                    ...
                    m = null,
                    y = new Date();
                if (l.scheduleAt.getTime() <= y.getTime())
                    ((u = !1), (p = 'Este agendamento já passou.'));
                else if (c) {
                    let e,
                        t,
                        r,
                        n =
                            ...
                            {
                                canReschedule: (r =
                                    (t = (a.getTime() - e.getTime()) / 36e5) >=
                                    c),
                                reason: r
                                    ? null
                                    : `Menos de ${c}h de anteced\xeancia.`,
                                diffHours: t,
                                windowHours: c,
                            });
                    ((u = n.canReschedule),
                    ...
                    ((h = (l.scheduleAt.getTime() - y.getTime()) / 36e5),
                        (m = null));
                let w = (function (e) {
                    let t,
                        r,
                        ...
                        s,
                        d =
                            ((t = new Intl.DateTimeFormat('en-CA', {
                    ...
                    return d.dateKey && d.timeHHMM
                        ? {
                              dateISO: new Date(
                                  `${d.dateKey}T12:00:00-03:00`
                              ).toISOString(),
                              startTime: d.timeHHMM,
                          }
                        : {
                              dateISO: new Date(
                                  e.getFullYear(),
                              ...
                              startTime: `${A(e.getHours())}:${A(e.getMinutes())}`,
                          };
                })(l.scheduleAt);
                return v.NextResponse.json(
                    {
                        ...
                        appointment: {
                            ...
                            barberId: l.professionalId ?? null,
                            barberName: l.professional?.name ?? null,
                            scheduleAt: l.scheduleAt.toISOString(),
                            dateISO: w.dateISO,
                ...
                console.error('[mobile/me/appointments/[id] GET] error:', r);
                ...
                return v.NextResponse.json(
                    ...
                    { status: t ? 401 : 500, headers: H() }
                );
            }
        }
        e.s(
            ['GET', () => T, 'OPTIONS', () => I, 'dynamic', 0, 'force-dynamic'],
            89318
        );
        var R = e.i(89318);
        let E = new t.AppRouteRouteModule({
                definition: {
                    ...
                    page: '/api/mobile/me/appointments/[id]/route',
                    pathname: '/api/mobile/me/appointments/[id]',
                    filename: 'route',
                    bundlePath: '',
                },
                distDir: '.next',
                relativeProjectDir: '',
                resolvedPagePath:
                    '[project]/src/app/api/mobile/me/appointments/[id]/route.ts',
        ...
        async function N(e, t, a) {
            ...
            let v = '/api/mobile/me/appointments/[id]/route';
            v = v.replace(/\/index$/, '') || '/';
            let S = await E.prepare(e, t, {
                srcPage: v,
            ...
            let {
                ...
                O = !!(T.dynamicRoutes[j] || T.routes[P]),
                k = async () => (
            ...
            if (O && !I) {
                let e = !!T.routes[P],
                    t = T.dynamicRoutes[j];
                if (t && !1 === t.fallback && !e) {
                    if (x.experimental.adapterPath) return await k();
                    throw new f.NoFallbackError();
                }
            }
            let _ = null;
            !O || E.isDev || I || (_ = '/index' === (_ = P) ? '/' : _);
            let U = !0 === E.isDev || !O,
                M = O && !U;
            N &&
                W &&
            ...
            try {
                let o = async (e) =>
                    ...
                    d = async (n) => {
                        ...
                        return (
                            (s && O) || u.delete(w.NEXT_CACHE_TAGS_HEADER),
                            !c.cacheControl ||
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a9a77049._.js.map
