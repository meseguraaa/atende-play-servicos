module.exports = [
    ...
    (e) => {
                ...
                ((0, l.checkKeyType)(w, e, 'sign'),
                    ...
                    this.#t
                        ? ((p = (0, t.encode)(JSON.stringify(this.#t))),
                          (h = (0, d.encode)(p)))
                        : ((p = ''), (h = new Uint8Array())));
                let x = (0, d.concat)(h, (0, d.encode)('.'), n),
                    v = await (0, u.normalizeKey)(e, w),
                    y = await s(w, v, x),
                    R = { signature: (0, t.encode)(y), payload: a };
                return (
                    this.#r && (R.header = this.#r),
                    this.#t && (R.protected = p),
                    R
                );
            }
        }
        ...
        class f {
            ...
            #n;
            constructor(e = {}) {
                this.#n = new g.JWTClaimsBuilder(e);
            }
            setIssuer(e) {
    ...
    (e) => {
        ...
        async function H(e) {
            ...
            let r,
                ...
                i = (function (e) {
                    let t,
                        r = String(e.get('redirect_uri') || '').trim();
                    if (!r) return null;
                    let a = b(r);
                    if (a) return a;
            ...
            if (
                !(
                    (r = i.toString()).startsWith('agendaplay://') ||
                    r.startsWith('exp://')
                )
            )
                return v.NextResponse.json(
            ...
            let o = String(process.env.GOOGLE_CLIENT_ID || '').trim();
            if (!o)
                return v.NextResponse.json(
                    { ok: !1, error: 'GOOGLE_CLIENT_ID não definido no .env' },
                    { status: 500 }
                );
            let d = (function (e) {
                let t,
            ...
            let l = new URL('/api/mobile/auth/google/callback', d),
                c = await new y.SignJWT({
                    companyId: s,
                    redirectUri: i.toString(),
                    provider: 'google',
                })
            ...
            return (
                u.searchParams.set('client_id', o),
                u.searchParams.set('redirect_uri', l.toString()),
                ...
                (t = u.toString()),
                (a = v.NextResponse.redirect(t, { status: 302 })).headers.set(
                    'Cache-Control',
                    'no-store, no-cache, must-revalidate, proxy-revalidate'
                ),
                a.headers.set('Pragma', 'no-cache'),
                a.headers.set('Expires', '0'),
                a
            );
        }
        e.s(['GET', () => H, 'dynamic', 0, 'force-dynamic'], 478316);
        var P = e.i(478316);
        let T = new t.AppRouteRouteModule({
                definition: {
                    kind: r.RouteKind.APP_ROUTE,
                    page: '/api/mobile/auth/google/start/route',
                    pathname: '/api/mobile/auth/google/start',
                    filename: 'route',
                    bundlePath: '',
                },
                distDir: '.next',
                relativeProjectDir: '',
                resolvedPagePath:
                    '[project]/src/app/api/mobile/auth/google/start/route.ts',
        ...
        async function U(e, t, a) {
            ...
            let v = '/api/mobile/auth/google/start/route';
            v = v.replace(/\/index$/, '') || '/';
            ...
            let {
                ...
                I = (0, d.normalizeAppPath)(v),
                k = !!(_.dynamicRoutes[I] || _.routes[U]),
                O = async () => (
                    (null == S ? void 0 : S.render404)
                        ? await S.render404(e, t, H, !1)
            ...
            try {
                let i = async (e) =>
                    ...
                    d = async (n) => {
                        ...
                        if (!k) return null;
                        if (
                            (null == c || null == (s = c.value)
                                ? void 0
                                : s.kind) !== x.CachedRouteKind.APP_ROUTE
                        )
                        ...
                        return (
                            (o && k) || u.delete(m.NEXT_CACHE_TAGS_HEADER),
                            !c.cacheControl ||
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c23d184e._.js.map
