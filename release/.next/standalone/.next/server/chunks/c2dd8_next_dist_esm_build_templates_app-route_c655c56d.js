module.exports = [
    ...
    (e) => {
        ...
        var v = e.i(377404),
            ...
            w = e.i(52359);
        function E(e, t) {
            return A.NextResponse.json({ ok: !0, data: e }, t);
        }
        function C(e, t = 400) {
        ...
        function x(e) {
            return (
                !!e &&
                'object' == typeof e &&
                ('PrismaClientValidationError' === e.name ||
                    e.constructor?.name === 'PrismaClientValidationError')
            );
        }
        function I(e) {
            return {
                ...
                isActive: 'boolean' != typeof e.isActive || e.isActive,
                createdAt: e.createdAt,
                updatedAt: e.updatedAt,
            };
        }
        async function N() {
            let e = await (0, w.getCurrentPainelUser)();
            if (!e || !e.companyId) throw Error('UNAUTHORIZED');
            if ('ADMIN' !== String(e.role).toUpperCase())
                throw Error('FORBIDDEN');
            let t = !0 === e.canSeeAllUnits;
            return { companyId: String(e.companyId), isOwner: t };
        }
        async function P() {
            try {
                let e = await N();
                return { ok: !0, session: e };
            } catch (e) {
                return {
                    ok: !1,
                    res: C(
        ...
        async function O() {
            ...
            try {
                let t = await g.prisma.unit.findMany({
                    where: { companyId: e.session.companyId },
        ...
        async function T(e) {
            ...
            if (!p.session.isOwner) return C('forbidden_owner_only', 403);
            let h = null;
            try {
                h = await e.json();
            } catch {
                return C('invalid_json', 400);
            }
            let m = b(h?.name);
            if (!m) return C('unit_name_required', 400);
            let f = b(h?.phone),
                R = b(h?.cep),
                y = b(h?.street),
                v = b(h?.number),
                ...
                N = b(h?.city),
                O = b(h?.state),
                T = 'boolean' != typeof h?.isActive || h.isActive,
                _ =
                    ((n = []),
                    (r = b(
                        (t = {
                    ...
                    (l = b(t.cep)),
                    (d = b(t.complement)),
                    (u = [r, a ? `, ${a}` : ''].join('').trim()) && n.push(u),
                    d && n.push(d),
                    i && n.push(i),
                    (c = [o, s].filter(Boolean).join(' - ')) && n.push(c),
                    l && n.push(`CEP ${l}`),
                    n.join(' • ') || null);
            try {
                let e = await g.prisma.unit.create({
                    data: {
                        companyId: p.session.companyId,
                        name: m,
                        phone: f,
                        cep: R,
                        street: y,
                ...
                return E(I(e), { status: 201 });
            } catch (e) {
                if (x(e))
                    return E(
                        I(
                            await g.prisma.unit.create({
                                data: {
                                    companyId: p.session.companyId,
                                    name: m,
                                    phone: f,
        ...
        e.s(
            ['GET', () => O, 'POST', () => T, 'dynamic', 0, 'force-dynamic'],
            405897
        );
        var _ = e.i(405897);
        let S = new t.AppRouteRouteModule({
                definition: {
                    ...
                    page: '/api/admin/settings/units/route',
                    pathname: '/api/admin/settings/units',
                    filename: 'route',
                    bundlePath: '',
                },
                distDir: '.next',
                relativeProjectDir: '',
                resolvedPagePath:
                    '[project]/src/app/api/admin/settings/units/route.ts',
        ...
        async function H(e, t, r) {
            ...
            let A = '/api/admin/settings/units/route';
            A = A.replace(/\/index$/, '') || '/';
            ...
            let {
                ...
                U = (0, l.normalizeAppPath)(A),
                k = !!(I.dynamicRoutes[U] || I.routes[T]),
                M = async () => (
            ...
            try {
                let o = async (e) =>
                        S.handle(G, K).finally(() => {
                            if (!e) return;
                            e.setAttributes({
                                'http.status_code': t.statusCode,
                                'next.rsc': !1,
                            });
                            let n = F.getRootSpanAttributes();
                            if (!n) return;
                            if (
...
//# sourceMappingURL=c2dd8_next_dist_esm_build_templates_app-route_c655c56d.js.map
