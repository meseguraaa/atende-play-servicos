module.exports = [
    ...
    (e) => {
        ...
        e.s(['GET', 0, E, 'POST', 0, E, 'dynamic', 0, 'force-dynamic'], 10185);
        var w = e.i(10185);
        let y = new t.AppRouteRouteModule({
                definition: {
                    kind: r.RouteKind.APP_ROUTE,
                    page: '/api/mobile/auth/[...nextauth]/route',
                    pathname: '/api/mobile/auth/[...nextauth]',
                    filename: 'route',
                    bundlePath: '',
                },
                distDir: '.next',
                relativeProjectDir: '',
                resolvedPagePath:
                    '[project]/src/app/api/mobile/auth/[...nextauth]/route.ts',
        ...
        async function N(e, t, a) {
            ...
            let g = '/api/mobile/auth/[...nextauth]/route';
            g = g.replace(/\/index$/, '') || '/';
            let E = await y.prepare(e, t, {
                srcPage: g,
            ...
            let {
                ...
                H = !!(N.dynamicRoutes[j] || N.routes[_]),
                M = async () => (
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a3026f4f._.js.map
