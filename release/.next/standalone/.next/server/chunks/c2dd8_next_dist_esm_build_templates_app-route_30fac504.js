module.exports = [
    ...
    (A) => {
        ...
        A.s(['GET', () => d, 'dynamic', 0, 'force-static'], 717868);
        var M = A.i(717868);
        let f = new w.AppRouteRouteModule({
                definition: {
        ...
        function v() {
            return (0, P.patchFetch)({
                workAsyncStorage: G,
                workUnitAsyncStorage: R,
            });
        }
        async function H(A, w, P) {
            f.isDev &&
                (0, e.addRequestMeta)(
                    A,
            ...
            let Q = '/favicon.ico/route';
            Q = Q.replace(/\/index$/, '') || '/';
            let E = await f.prepare(A, w, {
                srcPage: Q,
            ...
            if (!E)
                return (
                    ...
                    w.end('Bad Request'),
                    null == P.waitUntil ||
                        P.waitUntil.call(P, Promise.resolve()),
                    null
                );
            let {
                    buildId: d,
                    ...
                    revalidateOnlyGenerated: y,
                    resolvedPathname: O,
                    clientReferenceManifest: Y,
                    serverActionsManifest: T,
                } = E,
                j = (0, n.normalizeAppPath)(Q),
                V = !!(v.dynamicRoutes[j] || v.routes[O]),
                J = async () => (
                    (null == H ? void 0 : H.render404)
                        ? await H.render404(A, w, R, !1)
            ...
            T &&
                ...
                (0, r.setReferenceManifestsSingleton)({
                    ...
                    clientReferenceManifest: Y,
                    serverActionsManifest: T,
                    serverModuleMap: (0, g.createServerModuleMap)({
                        serverActionsManifest: T,
                    }),
                });
            let X = A.method || 'GET',
                ...
                x = {
                    ...
                    renderOpts: {
                        ...
                        incrementalCache: (0, e.getRequestMeta)(
                            A,
                            'incrementalCache'
                        ),
                        ...
                        onInstrumentationRequestError: (w, D, P) =>
                            f.onRequestError(A, w, P, H),
                    },
                    sharedContext: { buildId: d },
                },
                K = new o.NodeNextRequest(A),
                k = new o.NodeNextResponse(w),
                U = a.NextRequestAdapter.fromNodeNextRequest(
                    K,
                    (0, a.signalFromNodeResponse)(w)
                );
            try {
                let r = async (A) =>
                        f.handle(U, x).finally(() => {
                            if (!A) return;
                            A.setAttributes({
                                'http.status_code': w.statusCode,
                                'next.rsc': !1,
                            });
                            let D = b.getRootSpanAttributes();
                            if (!D) return;
                            if (
                                D.get('next.span_type') !==
                    ...
                    n = async (e) => {
                        ...
                        let o = async ({ previousCacheEntry: D }) => {
                                try {
                                    ...
                                    let n = x.renderOpts.pendingWaitUntil;
                                    n &&
                                        P.waitUntil &&
                                        (P.waitUntil(n), (n = void 0));
                                    let o = x.renderOpts.collectedTags;
                                    if (!V)
                                        return (
                                        ...
                                        );
                                    {
                                        let A = await t.blob(),
                                            w = (0,
                                            l.toNodeOutgoingHttpHeaders)(
                                                t.headers
                                            );
                                        (o && (w[C.NEXT_CACHE_TAGS_HEADER] = o),
                                            !w['content-type'] &&
                                                A.type &&
                                                (w['content-type'] = A.type));
                                        let D =
                                                void 0 !==
                                                    x.renderOpts
                                                        .collectedRevalidate &&
                        ...
                        if (!V) return null;
                        if (
                            (null == a || null == (t = a.value)
                                ? void 0
                                : t.kind) !== c.CachedRouteKind.APP_ROUTE
                        )
                        ...
                        let i = (0, l.fromNodeOutgoingHttpHeaders)(
                            a.value.headers
                        );
                        return (
                            (g && V) || i.delete(C.NEXT_CACHE_TAGS_HEADER),
                            !a.cacheControl ||
                                w.getHeader('Cache-Control') ||
                                i.get('Cache-Control') ||
                                i.set(
                                    'Cache-Control',
                                    (0, u.getCacheControlHeader)(a.cacheControl)
                                ),
                            await (0, s.sendResponse)(
                                K,
                                k,
                                new Response(a.value.body, {
                                    headers: i,
                                    status: a.value.status || 200,
                                })
                            ),
                            null
                        );
                ...
                if (
                    (w instanceof I.NoFallbackError ||
                        (await f.onRequestError(A, w, {
                            routerKind: 'App Router',
                            routePath: j,
                            routeType: 'route',
                            revalidateReason: (0, B.getRevalidateReason)({
                                isStaticGeneration: N,
                                isOnDemandRevalidate: h,
                            }),
                        })),
...
//# sourceMappingURL=c2dd8_next_dist_esm_build_templates_app-route_30fac504.js.map
