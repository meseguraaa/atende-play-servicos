module.exports = [
    ...
    (e) => {
        ...
        async function b(e) {
            ...
            let { payload: a } = await (0, w.jwtVerify)(
                    r,
                    (function () {
            ...
            let n =
                    'string' == typeof a?.companyId
                        ...
                        : '',
                o = String(e.headers.get('x-company-id') ?? '').trim() || '',
                s = n || o;
            if (!s) throw Error('companyid_missing');
            if (
                !(await v.prisma.companyMember.findFirst({
                    where: { userId: i, companyId: s, isActive: !0 },
                    select: { id: !0, role: !0 },
                }))
            )
        ...
        function S(e) {
            return (0, R.isToday)(e)
                ? `Hoje \xe0s ${(0, C.format)(e, 'HH:mm', { locale: T.ptBR })}`
                : (0, N.isYesterday)(e)
                  ? `Ontem \xe0s ${(0, C.format)(e, 'HH:mm', { locale: T.ptBR })}`
                  : (0, C.format)(e, 'dd/MM/yyyy • HH:mm', { locale: T.ptBR });
        }
        function _(e) {
        ...
        function O(e) {
            return String(e?.professional?.name ?? '').trim() || 'Profissional';
        }
        function M(e) {
        ...
        async function D() {
            return new y.NextResponse(null, { status: 204, headers: x() });
        }
        async function $(e) {
            try {
                let t = await b(e);
                ...
                let r = t.sub,
                    a = t.companyId;
                await P({ companyId: a, clientId: r });
                let [i, n, o, s] = await Promise.all([
                    ...
                    l = i
                        ...
                        .sort(
                            (e, t) =>
                                t.occurredAt.getTime() - e.occurredAt.getTime()
                        )
                        .map((e) => e.item)
                        .slice(0, 10),
                    c = n
        ...
        let k = new t.AppRouteRouteModule({
                definition: {
                    ...
                    page: '/api/mobile/me/history/route',
                    pathname: '/api/mobile/me/history',
                    filename: 'route',
                    bundlePath: '',
                },
                distDir: '.next',
                relativeProjectDir: '',
                resolvedPagePath:
                    '[project]/src/app/api/mobile/me/history/route.ts',
        ...
        async function B(e, t, a) {
            ...
            let y = '/api/mobile/me/history/route';
            y = y.replace(/\/index$/, '') || '/';
            ...
            let {
                ...
                D = !!(x.dynamicRoutes[M] || x.routes[_]),
                $ = async () => (
            ...
            try {
                let o = async (e) =>
                    ...
                    d = async (i) => {
                        ...
                        let u = (0, h.fromNodeOutgoingHttpHeaders)(
                            c.value.headers
                        );
                        return (
                            (s && D) || u.delete(f.NEXT_CACHE_TAGS_HEADER),
                            !c.cacheControl ||
                                t.getHeader('Cache-Control') ||
                                u.get('Cache-Control') ||
                                u.set(
                                    'Cache-Control',
                                    (0, A.getCacheControlHeader)(c.cacheControl)
                                ),
                            await (0, m.sendResponse)(
                                K,
                                G,
...
//# sourceMappingURL=c2dd8_next_dist_esm_build_templates_app-route_bff944c6.js.map
