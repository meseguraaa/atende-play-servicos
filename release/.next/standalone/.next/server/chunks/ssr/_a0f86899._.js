module.exports = [
    ...
    (a, b, c) => {
        ...
        for (var q in p)
            Object.defineProperty(c, q, { enumerable: !0, get: p[q] });
        var r =
            ...
            u =
                ...
                (g.clientComponentLoading =
                    'NextNodeServer.clientComponentLoading'),
                (g.getLayoutOrPageModule =
                    'NextNodeServer.getLayoutOrPageModule'),
                (g.generateStaticRoutes =
                    'NextNodeServer.generateStaticRoutes'),
                (g.generateFsStaticRoutes =
                    'NextNodeServer.generateFsStaticRoutes'),
                (g.generatePublicRoutes =
                    'NextNodeServer.generatePublicRoutes'),
                (g.generateImageRoutes =
    ...
    (a, b, c) => {
        ...
        for (var g in f)
            Object.defineProperty(c, g, { enumerable: !0, get: f[g] });
        let h = a.r(334061),
            i = a.r(889235);
        try {
            d = a.r(270406);
        ...
        function q(a) {
            return 'object' == typeof a && null !== a && a instanceof p;
        }
        let r = (a, b) => {
                (q(b) && b.bubble
            ...
            w =
                ((e = new (class a {
                    ...
                    getTracePropagationData() {
                        let a = j.active(),
                            b = [];
                        return (k.inject(a, b, v), b);
                    }
                    getActiveScopeSpan() {
                        return l.getSpan(null == j ? void 0 : j.active());
                    }
                    withPropagatedContext(a, b, c) {
                        let d = j.active();
                        if (l.getSpanContext(d)) return b();
                        let e = k.extract(d, a, c);
                        return j.with(e, b);
                    }
                    trace(...a) {
                        var b;
                        let [c, d, e] = a,
                            ...
                            k = g.spanName ?? c;
                        if (
                            (!h.NextVanillaSpanAllowlist.includes(c) &&
                                '1' !== process.env.NEXT_OTEL_VERBOSE) ||
                            g.hideSpan
                        )
                            return f();
                        let m = this.getSpanContext(
                                (null == g ? void 0 : g.parentSpan) ??
                                    this.getActiveScopeSpan()
                            ),
                            n = !1;
                        m
                            ? (null == (b = l.getSpanContext(m))
                                  ? void 0
                                  : b.isRemote) && (n = !0)
                            : ((m = (null == j ? void 0 : j.active()) ?? o),
                              (n = !0));
                        let p = u++;
                        return (
                            (g.attributes = {
                    ...
                    wrap(...a) {
                        ...
                        return h.NextVanillaSpanAllowlist.includes(c) ||
                            '1' === process.env.NEXT_OTEL_VERBOSE
                            ? function () {
                                  let a = d;
                                  'function' == typeof a &&
                    ...
                    getSpanContext(a) {
                        return a ? l.setSpan(j.active(), a) : void 0;
                    }
                    getRootSpanAttributes() {
                        let a = j.active().getValue(t);
                        return s.get(a);
                    }
                    setRootSpanAttribute(a, b) {
                        let c = j.active().getValue(t),
                            d = s.get(c);
                        d && !d.has(a) && d.set(a, b);
                    }
                })()),
        ...
        function i(a) {
            ...
            return function (c, d) {
                ...
                if ('string' != typeof c || d) {
                    let b,
                        e =
                            'string' == typeof c || c instanceof URL
                                ? new Request(c, d)
                                : c;
                    if (
    ...
    (a, b, c) => {
        ...
        function x(a, b) {
            ...
            return new TransformStream({
                transform(d, e) {
                    if (a && !c) {
                        c = !0;
                        let a = new TextDecoder('utf-8', { fatal: !0 }).decode(
                                d,
                                { stream: !0 }
                            ),
        ...
        function y({ ReactDOMServer: a, element: b, streamOptions: c }) {
            ...
            return new TransformStream({
                async transform(d, e) {
                    ...
                    if (-1 === f) {
                        if (
                            -1 ===
                            (f = (0, k.indexOfUint8Array)(
                                d,
                                j.ENCODED_TAGS.META.ICON_MARK
                            ))
                        )
                    ...
                    if (0 === b) {
                        if (
                            ((g = (0, k.indexOfUint8Array)(
                                d,
                                j.ENCODED_TAGS.CLOSED.HEAD
                            )),
                            -1 !== f)
                        ) {
                            if (f < g) {
                ...
                transform(b, c) {
                    ...
                    if (d > -1) {
                        if (
                            ((a = !0),
                            b.length ===
                                j.ENCODED_TAGS.CLOSED.BODY_AND_HTML.length)
                        )
                            return;
                        let e = b.slice(0, d);
                        if (
                            (c.enqueue(e),
                            b.length >
                                j.ENCODED_TAGS.CLOSED.BODY_AND_HTML.length + d)
                        ) {
                            let a = b.slice(
                                d + j.ENCODED_TAGS.CLOSED.BODY_AND_HTML.length
                            );
                            c.enqueue(a);
                        }
                    } else c.enqueue(b);
        ...
        function E() {
            ...
            return new TransformStream({
                async transform(c, d) {
                    (!a &&
                        (0, k.indexOfUint8Array)(
                            c,
                            j.ENCODED_TAGS.OPENING.HTML
                        ) > -1 &&
                        (a = !0),
                        !b &&
                            (0, k.indexOfUint8Array)(
                                c,
                                j.ENCODED_TAGS.OPENING.BODY
                            ) > -1 &&
                            (b = !0),
                        d.enqueue(c));
                },
...
Read more at https://nextjs.org/docs/messages/missing-root-layout-tags"
                                ...
                                write: async (b) => {
                                    if (!c) {
                                        if (
                                            ...
                                            let a = (0,
                                            j.getClientComponentLoaderMetrics)();
                                            a &&
                                                performance.measure(
    ...
    (a, b, c) => {
        ...
        let g = a.r(421728),
            h = (d = a.r(174743)) && d.__esModule ? d : { default: d },
            i = a.r(314292),
            j = a.r(298098);
        async function k(a) {
            var b, c;
        ...
        class i {
            ...
            async get(a, b, c) {
                ...
                if (
                    ...
                    return (0, h.toResponseCacheEntry)(
                    ...
                    if (
                        (e = this.minimal_mode
                            ...
                            : await c.incrementalCache.get(a, {
                                  kind: (0, h.routeKindToIncrementalCacheKind)(
                                      c.routeKind
                                  ),
        ...
        function u(a, { workAsyncStorage: b, workUnitAsyncStorage: c }) {
            let d = async function (d, e) {
                ...
                let v = (null == u ? void 0 : u.href) ?? '',
                    x =
                        (null == e || null == (k = e.method)
                            ? void 0
                            : k.toUpperCase()) || 'GET',
                    y =
                        (null == e || null == (o = e.next)
                            ? void 0
                            : o.internal) === !0,
                ...
                let E = (0, g.getTracer)().trace(
                    y
                        ? f.NextNodeServerSpan.internalFetch
                        : f.AppRenderSpan.fetch,
                    {
                        hideSpan: z,
                    ...
                    async () => {
                        ...
                        ('force-cache' === K && void 0 === F
                            ? (F = !1)
                            : (M || N) && (F = 0),
                            ('no-cache' === K || 'no-store' === K) &&
                                (L = `cache: ${K}`),
                            (o = p(F, B.route)));
                        let O = x('headers'),
                            P =
                                'function' ==
                                typeof (null == O ? void 0 : O.get)
                                    ? O
                                    : new Headers(O || {}),
                        ...
                        if (g && W) {
                            ...
                            if (a) {
                                ...
                                let b = new Response(
                                    ...
                                    { headers: a.headers, status: a.status }
                                );
                                return (
                    ...
                    let f =
                        ...
                        s = {
                            ...
                            draftMode:
                                k &&
                                e &&
                                (0, g.getDraftModeProviderForCacheScope)(e, k),
                        };
                    if (e) {
                        e.nextFetchId = q + 1;
                        let f = !1;
    ...
    (a, b, c) => {
        ...
        function g(a, b = !0) {
            return ((0, d.isInterceptionRouteAppPath)(a) &&
                (a = (0, d.extractInterceptionRouteInformation)(
                    a
                ).interceptedRoute),
            b)
                ? f.test(a)
        ...
        function q(a, b, c) {
            ...
            if (g) {
                ...
                switch (g.type) {
                    ...
                    case 'prerender-runtime':
                        ...
                        return (0,
                        f.abortAndThrowOnSynchronousRequestDataAccess)(
                            e.route,
                            b,
                            a,
                            g
            ...
            a))
                -1 ===
                    e.pendingRevalidatedTags.findIndex(
                        (a) =>
                            a.tag === b &&
                            ('string' == typeof a.profile &&
                            'string' == typeof c
                                ? a.profile === c
                                : 'object' == typeof a.profile &&
                                    'object' == typeof c
            ...
            let h =
                c && 'object' == typeof c
                    ...
                    : c &&
                        'string' == typeof c &&
                        (null == e || null == (d = e.cacheLifeProfiles)
                            ? void 0
                            : d[c])
                      ? e.cacheLifeProfiles[c]
                      : void 0;
            (c && (null == h ? void 0 : h.expire) !== 0) ||
                (e.pathWasRevalidated = !0);
        }
    },
    331459,
    (a, b, c) => {
    ...
    (a, b, c) => {
        let d = {
                unstable_cache: a.r(880425).unstable_cache,
                updateTag: a.r(779939).updateTag,
                revalidateTag: a.r(779939).revalidateTag,
                revalidatePath: a.r(779939).revalidatePath,
                refresh: a.r(779939).refresh,
                unstable_noStore: a.r(331459).unstable_noStore,
                cacheLife: a.r(250834).cacheLife,
                cacheTag: a.r(196561).cacheTag,
            },
            e = !1,
            f = !1;
    ...
    (a) => {
        ...
        let b = (0, a.i(976286).registerClientReference)(
            function () {
                throw Error(
                    "Attempted to call the default export of [project]/src/app/admin/review-tag/review-tag-toasts.tsx <module evaluation> from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component."
                );
            },
            '[project]/src/app/admin/review-tag/review-tag-toasts.tsx <module evaluation>',
            'default'
        );
        a.s(['default', 0, b]);
    },
    ...
    (a) => {
        ...
        let b = (0, a.i(976286).registerClientReference)(
            function () {
                throw Error(
                    "Attempted to call the default export of [project]/src/app/admin/review-tag/review-tag-toasts.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component."
                );
            },
            '[project]/src/app/admin/review-tag/review-tag-toasts.tsx',
            'default'
        );
        a.s(['default', 0, b]);
    },
    ...
    (a) => {
        ...
        var d = a.i(154840),
            ...
            j = a.i(850931),
            k = a.i(778106);
        let l = '/admin/review-tag';
        function m(a) {
            return a.map((a) => `${a.name}=${a.value}`).join('; ');
        }
        function n(a) {
            return String(a ?? '')
                .trim()
        ...
        async function o() {
            let a = await (0, f.headers)(),
                b =
                    a.get('x-forwarded-host') ??
                    a.get('host') ??
                    'localhost:3000',
                c = a.get('x-forwarded-proto') ?? 'http';
            return `${c}://${b}`;
        }
        let p = async function (a) {
            await (0, h.requireAdminForModule)('REVIEWS');
            let b = n(a.get('label'));
            b ||
                (0, d.redirect)(
                    `${l}?error=${encodeURIComponent('Informe o texto da tag.')}`
                );
            let c = m((await (0, f.cookies)()).getAll()),
                g = await o(),
                i = await fetch(`${g}/api/admin/review-tags`, {
                    method: 'POST',
            ...
            i ||
                (0, d.redirect)(
                    `${l}?error=${encodeURIComponent('Falha ao criar a tag.')}`
                );
            let j = await i.json().catch(() => null);
            if (!i.ok || !j || !0 !== j.ok) {
                let a =
                    j?.error ??
                    'Não foi possível criar a tag. Tente novamente.';
                (0, d.redirect)(`${l}?error=${encodeURIComponent(a)}`);
            }
            ((0, e.revalidatePath)(l),
                (0, d.redirect)(
                    `${l}?success=${encodeURIComponent('Tag criada com sucesso.')}`
                ));
        };
        (0, c.registerServerReference)(
            p,
            '40e10aa6ba2d41bb5ac5e74b8f2c8896be5e90f6bb',
            null
        );
        let q = async function (a) {
            await (0, h.requireAdminForModule)('REVIEWS');
            let b = String(a.get('tagId') ?? '').trim(),
                c = n(a.get('label'));
            (b ||
                (0, d.redirect)(
                    `${l}?error=${encodeURIComponent('Tag inválida.')}`
                ),
                c ||
                    (0, d.redirect)(
                        `${l}?error=${encodeURIComponent('Informe o texto da tag.')}`
                    ));
            let g = m((await (0, f.cookies)()).getAll()),
                i = await o(),
                j = await fetch(`${i}/api/admin/review-tags/${b}`, {
                    method: 'PATCH',
                    headers: { 'Content-Type': 'application/json', cookie: g },
                    body: JSON.stringify({ label: c }),
                    cache: 'no-store',
                }).catch(() => null);
            j ||
                (0, d.redirect)(
                    `${l}?error=${encodeURIComponent('Falha ao salvar o texto.')}`
                );
            let k = await j.json().catch(() => null);
            if (!j.ok || !k || !0 !== k.ok) {
                let a = k?.error ?? 'Não foi possível salvar. Tente novamente.';
                (0, d.redirect)(`${l}?error=${encodeURIComponent(a)}`);
            }
            ((0, e.revalidatePath)(l),
                (0, d.redirect)(
                    `${l}?success=${encodeURIComponent('Tag atualizada com sucesso.')}`
                ));
        };
        (0, c.registerServerReference)(
            q,
            '400951c187b1d723111ea29ee3cb9fd978894382a4',
            null
        );
        let r = async function (a) {
            await (0, h.requireAdminForModule)('REVIEWS');
            let b = String(a.get('tagId') ?? '').trim(),
                c = String(a.get('nextActive') ?? '').trim();
            b ||
                (0, d.redirect)(
                    `${l}?error=${encodeURIComponent('Tag inválida.')}`
                );
            let g = 'true' === c || ('false' !== c && null);
            null === g &&
                (0, d.redirect)(
                    `${l}?error=${encodeURIComponent('Ação inválida.')}`
                );
            let i = m((await (0, f.cookies)()).getAll()),
                j = await o(),
                k = await fetch(`${j}/api/admin/review-tags/${b}`, {
                    method: 'PATCH',
                    headers: { 'Content-Type': 'application/json', cookie: i },
                    body: JSON.stringify({ isActive: g }),
                    cache: 'no-store',
                }).catch(() => null);
            k ||
                (0, d.redirect)(
                    `${l}?error=${encodeURIComponent('Falha ao atualizar status.')}`
                );
            let n = await k.json().catch(() => null);
            if (!k.ok || !n || !0 !== n.ok) {
                let a =
                    n?.error ??
            ...
            ((0, e.revalidatePath)(l),
                (0, d.redirect)(
                    `${l}?success=${encodeURIComponent(g ? 'Tag ativada com sucesso.' : 'Tag desativada com sucesso.')}`
                ));
        };
        async function s({ searchParams: a }) {
            let c = await a,
                d = await (0, h.requireAdminForModule)('REVIEWS'),
                e = d.companyId,
                f = await g.prisma.reviewTag.findMany({
                    where: { companyId: e },
                    orderBy: { label: 'asc' },
                    select: {
                        id: !0,
                ...
                l = f.filter((a) => a.isActive),
                m = f.filter((a) => !a.isActive);
            return (0, b.jsxs)('div', {
                ...
                children: [
                        ...
                        children: (0, b.jsxs)('div', {
                            children: [
                                (0, b.jsx)('h1', {
                                    ...
                                    children: 'Tags de Avaliação',
                                }),
                                (0, b.jsx)('p', {
                                    className:
                                        'text-paragraph-medium text-content-secondary',
                                    children:
                                        'Gerencie as tags usadas para avaliações e feedbacks (no máximo 3 por avaliação).',
                                }),
                                (0, b.jsxs)('p', {
                                    className:
                    ...
                    (0, b.jsxs)('section', {
                        className:
                            'rounded-xl border border-border-primary bg-background-tertiary px-4 py-4 space-y-3',
                        children: [
                            (0, b.jsx)('p', {
                                className:
                                    'text-label-small text-content-primary',
                                children: 'Adicionar nova tag',
                            }),
                            (0, b.jsxs)('form', {
                                action: p,
                                className:
                                ...
                                children: [
                                    (0, b.jsx)(j.Input, {
                                        name: 'label',
                                        placeholder:
                                            'Ex.: Atendimento rápido, Ambiente agradável...',
                                        className:
                                            'bg-background-secondary border-border-primary text-content-primary placeholder:text-content-tertiary',
                                    }),
                                    (0, b.jsx)(i.Button, {
                                        type: 'submit',
                                        variant: 'edit2',
                            ...
                            (0, b.jsx)('p', {
                                ...
                                children:
                                    'Essas tags aparecem como opções para o cliente escolher (até 3) ao avaliar um atendimento.',
                            }),
                        ],
                    }),
                    (0, b.jsxs)('section', {
                            ...
                            0 === l.length
                                ? (0, b.jsx)('div', {
                                      ...
                                      children: (0, b.jsx)('p', {
                                          ...
                                          children:
                                              'Nenhuma tag ativa no momento. Cadastre acima ou ative uma tag inativa.',
                                      }),
                                  })
                                : (0, b.jsx)('div', {
                                      className: 'space-y-2',
                                      children: l.map((a) =>
                                          (0, b.jsxs)(
                                              ...
                                              {
                                                  className:
                                                      'flex flex-wrap items-center justify-between gap-3 rounded-xl border border-border-primary bg-background-tertiary px-4 py-3',
                                                  children: [
                                                      (0, b.jsxs)('form', {
                                                          action: q,
                                                          className:
                                                              ...
                                                              (0, b.jsx)(
                                                                  j.Input,
                                                                  {
                                                                      ...
                                                                      defaultValue:
                                                                          a.label,
                                                                      className:
                                                                          'flex-1 bg-background-secondary border-border-primary text-content-primary placeholder:text-content-tertiary',
                                                                  }
                                                              ),
                                                              (0, b.jsx)(
                                                                  i.Button,
                                                                  {
                                                                      ...
                                                                      variant:
                                                                          'edit2',
                                                                      className:
                                                                          'border-border-primary whitespace-nowrap',
                                                                      children:
                                                                          'Salvar texto',
                                                                  }
                                                              ),
                                                          ...
                                                          children: [
                                                              ...
                                                              (0, b.jsx)(
                                                                  i.Button,
                                                                  {
                                                                      ...
                                                                      size: 'sm',
                                                                      className:
                                                                          'border-border-primary hover:bg-muted/40 whitespace-nowrap',
                                                                      children:
                                                                          'Desativar',
                                                                  }
                                                              ),
        ...
        ((0, c.registerServerReference)(
            r,
            '40cba2ae4428f67f94428f273229d845ffed72692b',
            null
        ),
            a.s([
                '$$RSC_SERVER_ACTION_0',
...
//# sourceMappingURL=_a0f86899._.js.map
