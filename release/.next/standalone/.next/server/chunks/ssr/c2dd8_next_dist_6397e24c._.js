module.exports = [
    ...
    (a, b, c) => {
        'use strict';
        b.exports = a.r(978648).vendored['react-rsc'].ReactJsxRuntime;
    },
    976286,
    (a, b, c) => {
        'use strict';
        b.exports =
            a.r(978648).vendored['react-rsc'].ReactServerDOMTurbopackServer;
    },
    411769,
    (a, b, c) => {
        'use strict';
                ...
                );
            {
                var q,
                    ...
                    s = {
                        ...
                        path: i,
                        ...(j && {
                            sameSite: n.includes((q = (q = j).toLowerCase()))
                                ? q
                                : void 0,
                        }),
                        ...(k && { secure: !0 }),
                        ...(p && {
                            priority: o.includes((r = (r = p).toLowerCase()))
                                ? r
                                : void 0,
                        }),
                        ...(m && { partitioned: !0 }),
        ...
        var n = ['strict', 'lax', 'none'],
            ...
            q = class {
                ...
                delete(...a) {
                    let [b, c] =
                        'string' == typeof a[0] ? [a[0]] : [a[0].name, a[0]];
                    return this.set({
                        ...c,
                        name: b,
                        value: '',
    ...
    (a, b, c) => {
        'use strict';
        b.exports = a.r(978648).vendored['react-rsc'].React;
    },
    293077,
    (a, b, c) => {
        'use strict';
...
//# sourceMappingURL=c2dd8_next_dist_6397e24c._.js.map
