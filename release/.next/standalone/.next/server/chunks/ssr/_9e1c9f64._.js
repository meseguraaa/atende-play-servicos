module.exports = [
    ...
    (a) => {
        ...
        let I = [
                                        ...
                                        'analytics',
                                        {
                                            children: [
                                                ...
                                                {},
                                                {
                                                    ...
                                                    page: [
                                                        () => a.r(318284),
                                                        '[project]/src/app/admin/report/analytics/page.tsx',
                                                    ],
                                                },
                                            ],
                                        },
            ...
            K = new d.AppPageRouteModule({
                definition: {
                    ...
                    page: '/admin/report/analytics/page',
                    pathname: '/admin/report/analytics',
                    bundlePath: '',
                    filename: '',
                    appPaths: [],
                },
        ...
        async function L(a, b, c) {
            ...
            let M = '/admin/report/analytics/page';
            M = M.replace(/\/index$/, '') || '/';
...
//# sourceMappingURL=_9e1c9f64._.js.map
