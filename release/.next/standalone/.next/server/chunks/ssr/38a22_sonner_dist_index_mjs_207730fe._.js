        ...
        let d = Array(12).fill(0),
            e = ({ visible: a, className: c }) =>
                b.default.createElement(
                    'div',
                    {
                        className: ['sonner-loading-wrapper', c]
                            .filter(Boolean)
                            .join(' '),
                        'data-visible': a,
                    },
                ...
                constructor() {
                    ((this.subscribe = (a) => (
                        ...
                        (this.getActiveToasts = () =>
                            this.toasts.filter(
                                (a) => !this.dismissedToasts.has(a.id)
                            )),
                        (this.subscribers = []),
                        (this.toasts = []),
                    ...
                    onPointerDown: (a) => {
                        2 === a.button ||
                            ...
                            'BUTTON' !== a.target.tagName &&
                                (ad(!0),
                                (aB.current = { x: a.clientX, y: a.clientY })));
                    },
                    onPointerUp: () => {
                        var a, b, c, d, e;
                        if (ae || !as) return;
                            ...
                            ? b.default.createElement(
                                  ...
                                  B.filter(
                                      ...
                                      return b.default.createElement(q, {
                                          ...
                                          unstyled:
                                              null == u ? void 0 : u.unstyled,
                                          classNames:
                                              null == u ? void 0 : u.classNames,
                                          cancelButtonStyle:
                                              null == u
                                                  ? void 0
                                                  : u.cancelButtonStyle,
                                          ...
                                          closeButtonAriaLabel:
                                              null == u
                                                  ? void 0
                                                  : u.closeButtonAriaLabel,
                                          removeToast: P,
                                          toasts: B.filter(
                                              (a) => a.position == d.position
                                          ),
                                          heights: D.filter(
                                              (a) => a.position == d.position
                                          ),
