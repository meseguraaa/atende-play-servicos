module.exports = [
    ...
    (a, b, c) => {
        'use strict';
        b.exports = a.r(765463).vendored['react-ssr'].ReactJsxRuntime;
    },
    726514,
    (a, b, c) => {
        'use strict';
        b.exports = a.r(765463).vendored.contexts.AppRouterContext;
    },
    556704,
    (a, b, c) => {
        b.exports = a.x(
    ...
    (a, b, c) => {
        'use strict';
        b.exports = a.r(765463).vendored.contexts.HooksClientContext;
    },
    210553,
    (a, b, c) => {
        'use strict';
        b.exports = a.r(765463).vendored.contexts.ServerInsertedHtml;
    },
    113696,
    (a, b, c) => {
        'use strict';
        b.exports =
            a.r(765463).vendored['react-ssr'].ReactServerDOMTurbopackClient;
    },
    403988,
    (a, b, c) => {
        'use strict';
    ...
    (a) => {
        ...
        a.s(['default', () => g], 203431);
    },
    263758,
    (a) => {
        'use strict';
        let b = (0, a.i(203431).default)('building-2', [
        ...
        a.s(['Building2', () => b], 263758);
    },
    827569,
    (a) => {
        'use strict';
        let b = (0, a.i(203431).default)('layout-dashboard', [
            [
                'rect',
                {
                    width: '7',
        ...
        a.s(['LayoutDashboard', () => b], 827569);
    },
    226612,
    (a) => {
        'use strict';
        let b = (0, a.i(203431).default)('wallet', [
            [
                'path',
                {
    ...
    (a) => {
        'use strict';
        let b = (0, a.i(203431).default)('calendar-check', [
    ...
    (a) => {
        ...
        var b = a.i(584944),
            ...
            h = a.i(497990),
            i = a.i(226612);
        let j = (0, a.i(203431).default)('star', [
            [
                'path',
                {
        ...
        let l = [
            {
                ...
                label: 'Dashboard',
                icon: g.LayoutDashboard,
            },
            {
                href: '/professional/availability',
                label: 'Disponibilidade',
                icon: h.CalendarCheck,
            },
            { href: '/professional/earning', label: 'Ganhos', icon: i.Wallet },
            { href: '/professional/review', label: 'Avaliações', icon: j },
        ];
        async function m(a) {
            for (let b of [
                ...
                try {
                    ...
                    if (!c.ok) continue;
                    let d = await c.json().catch(() => null);
                    if (!d) continue;
                    let e = d?.id && d?.name ? d : null,
                        f = d?.data ?? null,
                        g = f?.id && f?.name ? f : null,
                        h = f?.unit?.id && f?.unit?.name ? f.unit : null,
                        i = d?.unit?.id && d?.unit?.name ? d.unit : null,
                        j = e ?? g ?? h ?? i;
                    if (j?.id && j?.name) return j;
                } catch {}
            return null;
        }
        function n({ className: a, unit: g }) {
            let h = (0, e.usePathname)(),
                [i, j] = c.default.useState(g ?? null);
            return (
                c.default.useEffect(() => {
                    if (g) return void j(g);
                        ...
                        i?.name
                            ? (0, b.jsx)('div', {
                                  ...
                                  children: (0, b.jsxs)('div', {
                                      className: (0, f.cn)('rounded-xl p-2'),
                                      children: [
                                          (0, b.jsxs)('div', {
                                              className:
        ...
        a.s(['ProfessionalNav', () => n], 359894);
    },
];

//# sourceMappingURL=%5Broot-of-the-server%5D__c275e222._.js.map
