module.exports = [
    ...
    (a) => {
        ...
        let I = [
                                        ...
                                        'rules',
                                        {
                                            children: [
                                                ...
                                                {},
                                                {
                                                    ...
                                                    page: [
                                                        () => a.r(268904),
                                                        '[project]/src/app/admin/client-level/rules/page.tsx',
                                                    ],
                                                },
                                            ],
                                        },
            ...
            K = new d.AppPageRouteModule({
                definition: {
                    ...
                    page: '/admin/client-level/rules/page',
                    pathname: '/admin/client-level/rules',
                    bundlePath: '',
                    filename: '',
                    appPaths: [],
                },
        ...
        async function L(a, b, c) {
            ...
            let M = '/admin/client-level/rules/page';
            M = M.replace(/\/index$/, '') || '/';
...
//# sourceMappingURL=_9c969c55._.js.map
