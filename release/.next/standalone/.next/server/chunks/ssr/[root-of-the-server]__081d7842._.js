module.exports = [
    ...
    (a) => {
        ...
        let b = (0, a.i(976286).registerClientReference)(
            function () {
                throw Error(
                    "Attempted to call PlataformNav() from the server but PlataformNav is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component."
                );
            },
            '[project]/src/components/plataform/plataform-nav/plataform-nav.tsx <module evaluation>',
            'PlataformNav'
        );
        a.s(['PlataformNav', 0, b]);
    },
    909916,
    (a) => {
        'use strict';
    ...
    (a) => {
        ...
        var c = a.i(154840),
            ...
            e = a.i(110329),
            f = a.i(352751);
        async function g({ children: a }) {
            let g = await (0, d.getCurrentPainelUser)();
            return (
                g || (0, c.redirect)('/painel/login?error=credenciais'),
                String(g.role || '').startsWith('PLATFORM') ||
                    (0, c.redirect)('/painel/login?error=permissao'),
                await (0, e.requirePlatformForModule)('DASHBOARD'),
                (0, b.jsxs)('div', {
                    className: 'min-h-screen bg-background-primary',
                    children: [
                        (0, b.jsx)(f.PlataformNav, {}),
                        (0, b.jsx)('main', {
                            className: 'pl-14',
        ...
        a.s(['default', () => g, 'dynamic', 0, 'force-dynamic'], 879629);
    },
];

//# sourceMappingURL=%5Broot-of-the-server%5D__081d7842._.js.map
