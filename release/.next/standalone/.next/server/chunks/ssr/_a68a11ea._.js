    ...
    (a) => {
        ...
        let I = [
                '',
                {
                    children: [
                                ...
                                'dashboard',
                                {
                                    children: [
                                        ...
                                        {},
                                        {
                                            ...
                                            page: [
                                                () => a.r(33505),
                                                '[project]/src/app/plataform/dashboard/page.tsx',
                                            ],
                                        },
                                    ],
                                },
                        ...
                        },
                        {
                            ...
                            layout: [
                                () => a.r(330400),
                                '[project]/src/app/plataform/layout.tsx',
                            ],
                        },
                    ],
                },
                {
                    ...
                    layout: [() => a.r(650645), '[project]/src/app/layout.tsx'],
                    'not-found': [
                        () => a.r(262530),
                        '[project]/node_modules/.pnpm/next@16.0.1_@babel+core@7.28.6_react-dom@19.2.0_react@19.2.0__react@19.2.0/node_modules/next/dist/client/components/builtin/not-found.js',
                    ],
                    forbidden: [
                        () => a.r(409171),
                        '[project]/node_modules/.pnpm/next@16.0.1_@babel+core@7.28.6_react-dom@19.2.0_react@19.2.0__react@19.2.0/node_modules/next/dist/client/components/builtin/forbidden.js',
                    ],
                    unauthorized: [
                        () => a.r(21802),
                        '[project]/node_modules/.pnpm/next@16.0.1_@babel+core@7.28.6_react-dom@19.2.0_react@19.2.0__react@19.2.0/node_modules/next/dist/client/components/builtin/unauthorized.js',
                    ],
                    'global-error': [
                        () => a.r(155517),
            ...
            K = new d.AppPageRouteModule({
                definition: {
                    ...
                    page: '/plataform/dashboard/page',
                    pathname: '/plataform/dashboard',
                    bundlePath: '',
                    filename: '',
                    appPaths: [],
                },
        ...
        async function L(a, b, c) {
            ...
            let M = '/plataform/dashboard/page';
            M = M.replace(/\/index$/, '') || '/';
            let N = !!(0, h.getRequestMeta)(a, 'minimalMode'),
                O = await K.prepare(a, b, {
                    srcPage: M,
            ...
            let {
                ...
                ap =
                    ...
                    (null == (d = Z.routes[af] ?? Z.dynamicRoutes[af])
                        ? void 0
                ...
                av =
                    (!al || !ap) &&
                    (!aj ||
                        (0, p.shouldServeStreamingMetadata)(
                            aj,
                            ac.htmlLimitedBots
                        )),
                ...
                ay =
                    ...
                    !aw ||
                    'string' == typeof as ||
                    (ax && (0, h.getRequestMeta)(a, 'onCacheEntryV2')
                        ? at && !N
                        : at),
                az = al && ap,
                aA = null;
            ...
            (!aB && K.isDev && (aB = _),
                K.isDev ||
                    ...
                    !an ||
                    at ||
                    (0, k.stripFlightHeaders)(a.headers));
            let aC = {
                ...D,
                tree: I,
                    ...
                    m = async ({
                        ...
                        let l = {
                            ...
                            renderOpts: {
                                ...
                                clientReferenceManifest: X,
                                setCacheStatus:
                                    null == ab ? void 0 : ab.setCacheStatus,
                                setIsrStatus:
                                    null == ab ? void 0 : ab.setIsrStatus,
                                setReactDebugChannel:
                                    null == ab
                                        ? void 0
                                        : ab.setReactDebugChannel,
                                dir: require('path').join(
                                    process.cwd(),
                                    K.relativeProjectDir
                                ),
                                isDraftMode: $,
                                botType: ak,
                                ...
                                experimental: {
                                    ...
                                    dynamicOnHover:
                                        !!ac.experimental.dynamicOnHover,
                                    inlineCss: !!ac.experimental.inlineCss,
                                    authInterrupts:
                                        !!ac.experimental.authInterrupts,
                                    clientTraceMetadata:
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
                            ...
                            if (null == a ? void 0 : a.stack) {
                                let c = a.stack;
                                b.stack =
                                    b.message + c.substring(c.indexOf('\n'));
                            }
                            throw b;
                        }
                        return {
                    ...
                    o = async ({
                        ...
                        if (
                            ...
                            (null == f ? void 0 : f.isStale) === -1 &&
                                (ag = !0),
                            ag &&
                                (l !== w.FallbackMode.NOT_FOUND || f) &&
                                (l = w.FallbackMode.BLOCKING_STATIC_RENDER),
                            !N &&
                                l !== w.FallbackMode.BLOCKING_STATIC_RENDER &&
                                aB &&
                            ...
                            if ((p || ah) && l === w.FallbackMode.NOT_FOUND) {
                                if (ac.experimental.adapterPath)
                                    return await aG();
                                ...
                                let b =
                                    ...
                                    d =
                                        ...
                                        (null == ah
                                            ...
                                            ? (0,
                                              n.createOpaqueFallbackRouteParams)(
                                                  ah.fallbackRouteParams
                                              )
                                            : ar
                                              ? (0, n.getFallbackRouteParams)(
                                                    af,
                                                    K
                                                )
                                              : null,
                        ...
                        if (as) l = { revalidate: 0, expire: void 0 };
                            ...
                            if ($) l = { revalidate: 0, expire: void 0 };
                                ...
                                if (n.cacheControl)
                                    if (
                                        'number' ==
                                        typeof n.cacheControl.revalidate
                                    ) {
                            ...
                            m({
                                ...
                                .then(async (a) => {
                                    ...
                                    if (!a)
                                        throw Object.defineProperty(
                                            Error(
                                                'Invariant: expected a result to be returned'
                                            ),
                                            '__NEXT_ERROR_CODE',
                                            {
                                                value: 'E463',
        ...
        (a.s(
            ['__next_app__', 0, J, 'handler', () => L, 'routeModule', 0, K],
            806752
        ),
            a.i(806752),
            a.s(
...
//# sourceMappingURL=_a68a11ea._.js.map
