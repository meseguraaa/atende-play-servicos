module.exports = [
    ...
    (a) => {
        ...
        let I = [
                                        ...
                                        'revenue',
                                        {
                                            children: [
                                                ...
                                                {},
                                                {
                                                    ...
                                                    page: [
                                                        () => a.r(559173),
                                                        '[project]/src/app/admin/report/revenue/page.tsx',
                                                    ],
                                                },
                                            ],
                                        },
            ...
            K = new d.AppPageRouteModule({
                definition: {
                    ...
                    page: '/admin/report/revenue/page',
                    pathname: '/admin/report/revenue',
                    bundlePath: '',
                    filename: '',
                    appPaths: [],
                },
        ...
        async function L(a, b, c) {
            ...
            let M = '/admin/report/revenue/page';
            M = M.replace(/\/index$/, '') || '/';
...
//# sourceMappingURL=_e85d94ea._.js.map
