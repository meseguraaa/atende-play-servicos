module.exports = [
    ...
    (a) => {
        ...
        let b = (0, a.i(976286).registerClientReference)(
            function () {
                throw Error(
                    "Attempted to call ProductRow() from the server but ProductRow is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component."
                );
            },
    ...
    (a) => {
        ...
        let b = (0, a.i(976286).registerClientReference)(
            function () {
                throw Error(
                    "Attempted to call ProductNewDialog() from the server but ProductNewDialog is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component."
                );
            },
            '[project]/src/components/admin/products/product-new-dialog/product-new-dialog.tsx <module evaluation>',
            'ProductNewDialog'
        );
        a.s(['ProductNewDialog', 0, b]);
    },
    78231,
    (a) => {
        'use strict';
    ...
    (a) => {
        ...
        async function g() {
            var a;
            let g, h;
            await (0, d.requireAdminForModule)('PRODUCTS');
            let i =
                    ((g =
                ...
                l = [];
            try {
                let a = i ? `${i}/api/admin/products` : '/api/admin/products',
                    b = await fetch(a, {
                        method: 'GET',
                        cache: 'no-store',
                        headers: { cookie: j, accept: 'application/json' },
                    }),
                    c = await b.json().catch(() => null);
                b.ok && c?.ok && c.data
                    ? ((k = c.data.products ?? []), (l = c.data.units ?? []))
                    : ((k = []), (l = []));
            } catch {
                ((k = []), (l = []));
            }
                            ...
                            (0, b.jsxs)('div', {
                                children: [
                                    ...
                                    (0, b.jsx)('p', {
                                        ...
                                        children:
                                            'Gerencie os produtos vendidos, estoque, categorias e comissões.',
                                    }),
                                ],
                            }),
                            (0, b.jsx)(f.ProductNewDialog, { units: l }),
                        ],
                    }),
                    (0, b.jsx)('section', {
                        className:
