    ...
    (a) => {
        ...
        async function f() {
            let a = await (0, c.headers)(),
                b = a.get('x-forwarded-host') ?? a.get('host'),
                d = a.get('x-forwarded-proto') ?? 'http';
            return b ? `${d}://${b}` : '';
        }
        async function g(a) {
            let b = await f(),
            ...
            a && c.set('month', a);
            let d = `${b}/api/professional/review${c.toString() ? `?${c.toString()}` : ''}`,
                g = await fetch(d, {
                    method: 'GET',
                    cache: 'no-store',
                    headers: { cookie: await e() },
                });
            return await g.json();
        }
        async function h({ searchParams: a }) {
            ...
            let {
                    ...
                    topPositiveTags: i,
                    topNegativeTags: j,
                    recentPositiveReviews: k,
                    recentNegativeReviews: l,
                } = e.data,
                m = h.totalReviewsMonth,
                n = h.totalReviewsOverall,
                o = m > 0 ? h.averageRatingMonth.toFixed(2) : '—',
                p = n > 0 ? h.averageRatingOverall.toFixed(2) : '—';
            return (0, b.jsxs)('div', {
                className: 'max-w-7xl space-y-6',
                children: [
                    (0, b.jsxs)('header', {
                            ...
                            (0, b.jsxs)('div', {
                                children: [
                                    ...
                                    (0, b.jsx)('p', {
                                        ...
                                        children:
                                            'Algumas avaliações podem ter o nome do cliente oculto, isso acontece quando ele opta por avaliação anônima.',
                                    }),
                                ],
                            }),
                            (0, b.jsx)('div', {
