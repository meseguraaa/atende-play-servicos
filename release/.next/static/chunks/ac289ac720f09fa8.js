(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
    ...
    (e) => {
        ...
        ((o.displayName = 'VisuallyHidden'),
            e.s(['Root', () => o, 'VISUALLY_HIDDEN_STYLES', () => a]));
    },
    672687,
    (e) => {
        'use strict';
                    ...
                    if (u) {
                        ...
                        return (0, n.jsx)(l, {
                            ...
                            children: t.isValidElement(e)
                                ? t.cloneElement(e, void 0, a)
                                : null,
                        });
                    }
                    return (0, n.jsx)(l, { ...s, ref: r, children: a });
                });
    ...
    (e) => {
        ...
        function d({
            ...
            let d = o ? r.Slot : 'button';
            return (0, t.jsx)(d, {
                'data-slot': 'button',
                className: (0, s.cn)(l({ variant: n, size: a, className: e })),
                ...i,
            });
        }
    ...
    (e) => {
        ...
        var n = e.i(990341),
            ...
            g = e.i(880282),
            x = e.i(565750),
            [h, v] = (0, i.createContextScope)('Tooltip', [
                d.createPopperScope,
            ]),
        ...
        var A = 'TooltipTrigger',
            E = n.forwardRef((e, t) => {
                let { __scopeTooltip: r, ...i } = e,
                    ...
                    c = b(r),
                    u = n.useRef(null),
                    f = (0, o.useComposedRefs)(t, u, s.onTriggerChange),
                    m = n.useRef(!1),
                    g = n.useRef(!1),
                ...
                return (
                    ...
                    (0, x.jsx)(d.Anchor, {
                        asChild: !0,
                        ...c,
                        children: (0, x.jsx)(p.Primitive.button, {
        ...
        var P = 'TooltipPortal',
            ...
            S = (e) => {
                ...
                return (0, x.jsx)(O, {
                    scope: t,
                    forceMount: r,
                    children: (0, x.jsx)(u.Presence, {
                        present: r || o.open,
                        children: (0, x.jsx)(c.Portal, {
                            asChild: !0,
                            container: a,
                            children: n,
                        }),
        ...
        var M = 'TooltipContent',
            _ = n.forwardRef((e, t) => {
                let r = I(M, e.__scopeTooltip),
                    { forceMount: n = r.forceMount, side: a = 'top', ...o } = e,
                    i = T(M, e.__scopeTooltip);
                return (0, x.jsx)(u.Presence, {
                    present: n || i.open,
                    children: i.disableHoverableContent
                        ? (0, x.jsx)(B, { side: a, ...o, ref: t })
                        : (0, x.jsx)(F, { side: a, ...o, ref: t }),
                });
            }),
            F = n.forwardRef((e, t) => {
            ...
            [z, L] = h(D, { isInside: !1 }),
            H = (0, f.createSlottable)('TooltipContent'),
            B = n.forwardRef((e, t) => {
                let {
                        __scopeTooltip: r,
                        children: a,
                ...
                return (
                    n.useEffect(
                        () => (
                            document.addEventListener(j, f),
                            () => document.removeEventListener(j, f)
                        ),
                        [f]
                    ),
                    n.useEffect(() => {
                    ...
                    (0, x.jsx)(s.DismissableLayer, {
                        ...
                        children: (0, x.jsxs)(d.Content, {
                            ...
                            children: [
                                (0, x.jsx)(H, { children: a }),
                                (0, x.jsx)(z, {
                                    scope: r,
                                    isInside: !0,
                                    children: (0, x.jsx)(g.Root, {
                                        id: u.contentId,
                                        role: 'tooltip',
                                        children: o || a,
                                    }),
        ...
        var U = 'TooltipArrow',
            $ = n.forwardRef((e, t) => {
                let { __scopeTooltip: r, ...n } = e,
                    a = b(r);
                return L(U, r).isInside
                    ? null
                    : (0, x.jsx)(d.Arrow, { ...a, ...n, ref: t });
            });
        (($.displayName = U),
            e.s(
                [
        ...
        function Y({ ...e }) {
            return (0, x.jsx)(W, {
                children: (0, x.jsx)(k, { 'data-slot': 'tooltip', ...e }),
            });
        }
        function G({ ...e }) {
            return (0, x.jsx)(E, { 'data-slot': 'tooltip-trigger', ...e });
        }
        function q({ className: e, sideOffset: t = 0, children: r, ...n }) {
            return (0, x.jsx)(S, {
                children: (0, x.jsxs)(_, {
    ...
    (e) => {
        ...
        var t = e.i(565750),
            ...
            x = e.i(83972),
            h = e.i(746798);
        let v = ({ tooltipText: e, onClick: r, children: n }) =>
            (0, t.jsx)(x.TooltipProvider, {
                children: (0, t.jsxs)(h.Tooltip, {
                    children: [
                        (0, t.jsx)(h.TooltipTrigger, {
                            asChild: !0,
                ...
                ({ mode: e = 'date', hideNavigation: x }) => {
                    let h = (0, i.useRouter)(),
                        ...
                        w = (0, s.useCallback)(() => {
                            ...
                            if (!N) return new Date();
                            let [t, r, n] = N.split('-').map(Number),
                                a = new Date(t, (r ?? 1) - 1, n ?? 1);
                            return (0, u.isValid)(a) ? a : new Date();
                        }, [e, N]),
                        [C, D] = (0, s.useState)(() => w()),
                        [R, T] = (0, s.useState)(!1),
                        k = (0, s.useMemo)(
                    ...
                    let P = 'month' === e ? 'Mês anterior' : 'Dia anterior',
    ...
    (e) => {
        'use strict';
        let t = (0, e.i(383206).default)('scissors', [
    ...
    (e) => {
        ...
        var w = 'DialogTrigger',
            C = t.forwardRef((e, t) => {
                ...
                return (0, x.jsx)(u.Primitive.button, {
                    type: 'button',
        ...
        var A = 'DialogOverlay',
            E = t.forwardRef((e, t) => {
                let r = T(A, e.__scopeDialog),
                    { forceMount: n = r.forceMount, ...a } = e,
                    o = j(A, e.__scopeDialog);
                return o.modal
                    ? (0, x.jsx)(c.Presence, {
                          present: n || o.open,
                          children: (0, x.jsx)(O, { ...a, ref: t }),
                      })
                    : null;
            });
        E.displayName = A;
        var P = (0, g.createSlot)('DialogOverlay.RemoveScroll'),
            O = t.forwardRef((e, t) => {
                let { __scopeDialog: r, ...n } = e,
                    a = j(A, r);
                return (0, x.jsx)(f.RemoveScroll, {
                    as: P,
                    allowPinchZoom: !0,
                    shards: [a.contentRef],
                    children: (0, x.jsx)(u.Primitive.div, {
                        'data-state': V(a.open),
                        ...n,
                        ref: t,
        ...
        S.displayName = I;
        var M = t.forwardRef((e, a) => {
                let o = j(I, e.__scopeDialog),
                    i = t.useRef(null),
            ...
            F = t.forwardRef((e, r) => {
                let {
                    ...
                    u = j(I, a),
                    f = t.useRef(null),
                    m = (0, n.useComposedRefs)(r, f);
                return (
                    (0, p.useFocusGuards)(),
                    (0, x.jsxs)(x.Fragment, {
                        children: [
                            (0, x.jsx)(l.FocusScope, {
                                asChild: !0,
                                loop: !0,
                                trapped: o,
                                onMountAutoFocus: i,
                                onUnmountAutoFocus: d,
                                children: (0, x.jsx)(s.DismissableLayer, {
                                    role: 'dialog',
                                    id: u.contentId,
...
For more information, see https://radix-ui.com/primitives/docs/components/${r.docsSlug}`;
            ...
            K = ({ contentRef: e, descriptionId: r }) => {
                let n = G('DialogDescriptionWarning'),
    ...
    (e) => {
        ...
        function c({ className: e, variant: n, ...a }) {
            return (0, t.jsx)(r.Overlay, {
                'data-slot': 'dialog-overlay',
                className: (0, o.cn)(d({ variant: n }), e),
                ...a,
            });
        }
        let u = (0, a.cva)(
        ...
        function m({ className: e, align: r, ...n }) {
            return (0, t.jsx)('div', {
                'data-slot': 'dialog-header',
                className: (0, o.cn)(f({ align: r }), e),
                ...n,
            });
        }
        ...
        let x = (0, a.cva)('leading-none font-semibold', {
            variants: {
                size: {
                    sm: 'text-base',
                    default: 'text-lg',
        ...
        function h({ className: e, size: n, ...a }) {
            return (0, t.jsx)(r.Title, {
                'data-slot': 'dialog-title',
                className: (0, o.cn)(x({ size: n }), e),
                ...a,
            });
        }
        let v = (0, a.cva)('text-muted-foreground', {
            variants: {
                size: {
                    sm: 'text-xs',
                    default: 'text-sm',
        ...
        function b({ className: e, size: n, ...a }) {
            return (0, t.jsx)(r.Description, {
                'data-slot': 'dialog-description',
                className: (0, o.cn)(v({ size: n }), e),
                ...a,
            });
        }
        e.s(
    ...
    (e) => {
        ...
        var t = e.i(565750),
            ...
            s = e.i(655875),
            l = 'AlertDialog',
            [d, c] = (0, n.createContextScope)(l, [o.createDialogScope]),
            u = (0, o.createDialogScope)(),
            p = (e) => {
                let { __scopeAlertDialog: r, ...n } = e,
                    a = u(r);
                return (0, t.jsx)(o.Root, { ...a, ...n, modal: !0 });
            };
        p.displayName = l;
        var f = r.forwardRef((e, r) => {
            let { __scopeAlertDialog: n, ...a } = e,
                i = u(n);
            return (0, t.jsx)(o.Trigger, { ...i, ...a, ref: r });
        });
        f.displayName = 'AlertDialogTrigger';
        var m = (e) => {
            let { __scopeAlertDialog: r, ...n } = e,
                a = u(r);
            return (0, t.jsx)(o.Portal, { ...a, ...n });
        };
        m.displayName = 'AlertDialogPortal';
        var g = r.forwardRef((e, r) => {
            let { __scopeAlertDialog: n, ...a } = e,
                i = u(n);
            return (0, t.jsx)(o.Overlay, { ...i, ...a, ref: r });
        });
        g.displayName = 'AlertDialogOverlay';
        var x = 'AlertDialogContent',
            [h, v] = d(x),
            b = (0, s.createSlottable)('AlertDialogContent'),
            y = r.forwardRef((e, n) => {
                let { __scopeAlertDialog: s, children: l, ...d } = e,
                    c = u(s),
                    p = r.useRef(null),
                    f = (0, a.useComposedRefs)(n, p),
                    m = r.useRef(null);
                return (0, t.jsx)(o.WarningProvider, {
                    ...
                    children: (0, t.jsx)(h, {
                        ...
                        children: (0, t.jsxs)(o.Content, {
                            ...
                            ...d,
                            ref: f,
                            onOpenAutoFocus: (0, i.composeEventHandlers)(
                                d.onOpenAutoFocus,
                                (e) => {
                                    (e.preventDefault(),
                                        m.current?.focus({
        ...
        var j = 'AlertDialogTitle',
            N = r.forwardRef((e, r) => {
                let { __scopeAlertDialog: n, ...a } = e,
                    i = u(n);
                return (0, t.jsx)(o.Title, { ...i, ...a, ref: r });
            });
        N.displayName = j;
        var w = 'AlertDialogDescription',
            C = r.forwardRef((e, r) => {
                let { __scopeAlertDialog: n, ...a } = e,
                    i = u(n);
                return (0, t.jsx)(o.Description, { ...i, ...a, ref: r });
            });
        C.displayName = w;
        var D = r.forwardRef((e, r) => {
            let { __scopeAlertDialog: n, ...a } = e,
                i = u(n);
            return (0, t.jsx)(o.Close, { ...i, ...a, ref: r });
        });
        ...
        var R = 'AlertDialogCancel',
            T = r.forwardRef((e, r) => {
                let { __scopeAlertDialog: n, ...i } = e,
                    { cancelRef: s } = v(R, n),
                    l = u(n),
                    d = (0, a.useComposedRefs)(r, s);
                return (0, t.jsx)(o.Close, { ...l, ...i, ref: d });
            });
        T.displayName = R;
        var k = ({ contentRef: e }) => {
            let t = `\`${x}\` requires a description for the component to be accessible for screen reader users.
...
For more information, see https://radix-ui.com/primitives/docs/components/alert-dialog`;
        ...
        var A = e.i(975157),
            E = e.i(519455);
        let P = r.forwardRef(({ className: e, ...r }, n) =>
            (0, t.jsx)(g, {
                className: (0, A.cn)(
        ...
        let O = r.forwardRef(({ className: e, ...r }, n) =>
            (0, t.jsxs)(m, {
                children: [
                    (0, t.jsx)(P, {}),
                    (0, t.jsx)(y, {
        ...
        S.displayName = 'AlertDialogFooter';
        let M = r.forwardRef(({ className: e, ...r }, n) =>
            (0, t.jsx)(N, {
                ref: n,
                className: (0, A.cn)(
        ...
        let _ = r.forwardRef(({ className: e, ...r }, n) =>
            (0, t.jsx)(C, {
                ref: n,
                className: (0, A.cn)(
        ...
        let F = r.forwardRef(({ className: e, ...r }, n) =>
            (0, t.jsx)(D, {
                ref: n,
                className: (0, A.cn)(
        ...
        let z = r.forwardRef(({ className: e, ...r }, n) =>
            (0, t.jsx)(T, {
                ref: n,
                className: (0, A.cn)(
    ...
    (e) => {
        ...
        function u({
            ...
            let h,
                ...
                D =
                    ((v = String(
                        (h =
                            (x = e.scheduleAt) instanceof Date
                                ? x
                                : new Date(x)).getHours()
                    ).padStart(2, '0')),
                    (b = String(h.getMinutes()).padStart(2, '0')),
                    `${v}:${b}`),
                R = {
                    id: e.id,
                    unitId: e.unitId,
                ...
                T = async () => {
                    try {
                        N('done');
                        let t = await fetch(
                                `/api/professional/appointments/${e.id}`,
                                {
                                    method: 'PATCH',
                                    headers: {
                        ...
                        (r?.data?.orderCreated
                            ...
                            : a.toast.success('Agendamento concluído!'),
                            y.refresh());
                    } catch {
                        a.toast.error('Erro ao concluir o agendamento.');
                    } finally {
                        N(null);
                    }
                },
                k = async () => {
                    try {
                        ...
                        (a.toast.success('Agendamento cancelado.'),
                            y.refresh());
                    } catch {
                        a.toast.error('Erro ao cancelar o agendamento.');
                    } finally {
                        N(null);
                    }
                };
            return (0, t.jsxs)('tr', {
                ...
                children: [
                    ...
                    (0, t.jsx)('td', {
                        className: 'px-4 py-3',
                        children: (0, t.jsx)(c, { status: e.status }),
                    }),
                    (0, t.jsx)('td', {
                        ...
                        children: w
                            ? (0, t.jsxs)('div', {
                                  ...
                                  children: [
                                      ...
                                      (0, t.jsxs)(s.AlertDialog, {
                                          children: [
                                              (0, t.jsx)(s.AlertDialogTrigger, {
                                                  asChild: !0,
                                                  children: (0, t.jsx)(
                                                      o.Button,
                                                      {
        ...
        function p({
            ...
            let c = r.useMemo(() => {
                let e = new Map(),
                    t = i.find((e) => e.id === a) ?? null,
                    r = t?.name ?? 'Profissional',
                    n = t?.imageUrl ?? null,
                    o = a || 'no-professional';
                e.set(o, {
                    key: o,
                    professionalId: a || null,
                    professionalName: r,
                ...
                for (let e of (s.sort((e, t) =>
                    (function (e, t) {
                        try {
                            return e.localeCompare('pt-BR', void 0, {
                                sensitivity: 'base',
                            });
                        } catch {
                            return e.localeCompare(t);
                        }
                    })(e.professionalName, t.professionalName)
                ),
                s))
                    e.appointments.sort(
                        (e, t) =>
            ...
            r.useMemo(() => {
                let e = o.find((e) => e.id === n);
                return e?.name ?? null;
            }, [n, o]);
            let p = r.useMemo(
                () => o.map((e) => ({ id: e.id, name: e.name })),
                [o]
            );
            return (0, t.jsx)('div', {
                className: 'space-y-4',
