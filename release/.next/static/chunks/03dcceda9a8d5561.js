(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
    ...
    (e) => {
        ...
        ((s.displayName = 'VisuallyHidden'),
            e.s(['Root', () => s, 'VISUALLY_HIDDEN_STYLES', () => a]));
    },
    672687,
    (e) => {
        'use strict';
                ...
                (
                    ...
                    (0, t.createElement)(
                        'svg',
                        {
                            ...
                            height: r,
                            stroke: e,
                            strokeWidth: i ? (24 * Number(s)) / Number(r) : s,
                        ...
                        [
                            ...l.map(([e, r]) => (0, t.createElement)(e, r)),
                            ...(Array.isArray(c) ? c : [c]),
                        ]
                    )
            ),
            i = (e, a) => {
                let i = (0, t.forwardRef)(({ className: i, ...o }, c) =>
                    (0, t.createElement)(s, {
                        ref: c,
                        iconNode: a,
                        className: n(
    ...
    (e, t, r) => {
        ...
        function o(e) {
            ...
            ((t = t ? encodeURIComponent(t).replace(/%3A/i, ':') + '@' : ''),
                ...
                c &&
                    'object' == typeof c &&
                    (c = String(s.urlQueryToSearchParams(c))));
            let u = e.search || (c && `?${c}`) || '';
            return (
                n && !n.endsWith(':') && (n += ':'),
    ...
    (e, t, r) => {
        ...
        function g(t) {
            ...
            let U = o.default.useContext(l.AppRouterContext),
                ...
                K =
                    !1 !== S
                        ...
                        : y.FetchStrategy.PPR,
                { href: I, as: D } = o.default.useMemo(() => {
                    let e = m(k);
                    return { href: e, as: x ? m(x) : e };
                }, [k, x]);
            if (E) {
            ...
            let z = E ? a && 'object' == typeof a && a.ref : R,
                B = o.default.useCallback(
                    (e) => (
                        null !== U &&
                            (b.current = (0, p.mountLinkInstance)(
                                e,
                                I,
                                U,
                                K,
            ...
            return (
                (0, d.isAbsoluteUrl)(D)
                    ? (F.href = D)
                    : (E && !P && ('a' !== a.type || 'href' in a.props)) ||
                      (F.href = (0, f.addBasePath)(D)),
                (s = E
                    ? o.default.cloneElement(a, F)
                    : (0, i.jsx)('a', { ...T, ...F, children: n })),
                (0, i.jsx)(v.Provider, { value: c, children: s })
            );
        }
        e.r(90112);
    ...
    (e) => {
        'use strict';
        let t = (0, e.i(383206).default)('users', [
            [
                'path',
                {
    ...
    (e) => {
        'use strict';
        let t = (0, e.i(383206).default)('package', [
            [
                'path',
                {
    ...
    (e) => {
        'use strict';
        let t = (0, e.i(383206).default)('tag', [
            [
                'path',
                {
    ...
    (e) => {
        'use strict';
        let t = (0, e.i(383206).default)('handshake', [
        ...
        e.s(['Handshake', () => t], 942233);
    },
    121085,
    (e) => {
        'use strict';
        let t = (0, e.i(383206).default)('settings', [
            [
                'path',
                {
        ...
        e.s(['Settings', () => t], 121085);
    },
    935682,
    (e) => {
        'use strict';
        let t = (0, e.i(383206).default)('chart-column', [
            ['path', { d: 'M3 3v16a2 2 0 0 0 2 2h16', key: 'c24i48' }],
            ['path', { d: 'M18 17V9', key: '2bz60n' }],
            ['path', { d: 'M13 17V5', key: '1frdt8' }],
            ['path', { d: 'M8 17v-3', key: '17ska0' }],
        ]);
        e.s(['BarChart3', () => t], 935682);
    },
    566440,
    (e) => {
        'use strict';
        ...
        var u = e.i(60179),
            ...
            f = e.i(202724),
            p = e.i(977247);
        let h = (0, c.default)('shopping-cart', [
        ...
        let S = new Set(
            (
                w.default.env.ADMIN_DISABLED_MODULES ??
                w.default.env.NEXT_PUBLIC_ADMIN_DISABLED_MODULES ??
                ''
            )
                .split(',')
                .map((e) => e.trim())
        ...
        function P(e) {
            return 'partners' !== e && !S.has(String(e));
        }
        let j = [
            {
        ...
        let M = {
                ...
                reports: g.BarChart3,
                appointments: p.CalendarCheck,
                checkout: h,
                professionals: o.Scissors,
                services: l,
                reviews: y.Tag,
                products: u.Package,
                partners: k.Handshake,
                clients: f.Users,
                clientLevels: b,
                finance: d.Wallet,
                settings: m.Settings,
            },
            C = 'admin_unit_context',
            N = new Set(['partners']);
        function _(e, t) {
            'undefined' == typeof document ||
                (document.cookie = `${encodeURIComponent(e)}=${encodeURIComponent(t)}; Path=/; Max-Age=31536000; SameSite=Lax`);
        }
        function E({
            className: e,
            adminAccess: i,
            ...
            let l = (0, a.usePathname)(),
                ...
                p = j.filter((e) => {
                    var t;
                    return (
                        !(!e.enabled || N.has(String(e.menuKey))) &&
                        ((t = e.menuKey), !!f && !!f[x[t]])
                    );
                }),
                h = !!c?.length,
                [y, m] = r.default.useState(''),
                g = r.default.useRef(!1);
            return (
                r.default.useEffect(() => {
                    ...
                    if (t && e.some((e) => e.id === t)) {
                        (m(t), (g.current = !0));
                        return;
                    }
                    let r = e[0]?.id;
                    r && (_(C, r), m(r), (g.current = !0), u.refresh());
                }, [u, h, c]),
                (0, t.jsxs)('nav', {
                    className: (0, s.cn)(
                        ...
                        h &&
                            (0, t.jsx)('div', {
                                ...
                                children: (0, t.jsxs)('div', {
                                    className: (0, s.cn)('rounded-xl p-2'),
                                    children: [
                                        (0, t.jsxs)('div', {
                                            className:
    ...
    (e) => {
        ...
        function s() {
            let e = (0, n.useSearchParams)(),
                ...
                i = (0, n.useRouter)(),
                o = e?.get('error') || null,
                c = (0, r.useMemo)(() => 'permissao' === o, [o]),
                [l, u] = (0, r.useState)(!1),
                [d, f] = (0, r.useState)('error'),
                [p, h] = (0, r.useState)('Sem permissão.');
            return ((0, r.useEffect)(() => {
                if (!c) return;
                (f('error'), h('Sem permissão.'), u(!0));
                let t = new URLSearchParams(e?.toString() || '');
                t.delete('error');
                let r = `${s || '/admin/dashboard'}${t.toString() ? `?${t.toString()}` : ''}`;
                i.replace(r);
                let n = setTimeout(() => u(!1), 2600);
                return () => {
                    clearTimeout(n);
                };
            }, [c, i, s, e]),
                              ...
                              children: [
                                  ...
                                  (0, t.jsxs)('div', {
                                      ...
                                      children: [
                                          (0, t.jsx)('p', {
                                              className:
                                                  'text-paragraph-small text-content-primary',
                                              children: p,
                                          }),
                                          (0, t.jsx)('p', {
                                              className:
                                                  'mt-0.5 text-[11px] text-content-secondary',
                                              children:
