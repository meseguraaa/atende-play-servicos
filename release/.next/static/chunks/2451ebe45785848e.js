(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
    ...
    (e, t, r) => {
        ...
        function U(e) {
            ...
            try {
                ...
                if (null !== o)
                    for (
                        e.value = null, e.reason = null, r = 0;
                        r < o.length;
                        r++
                    ) {
                        var a = o[r];
                        'function' == typeof a ? a(u) : F(a, u, e);
                    }
                if (null !== N) {
        ...
        function eu(e, t, r, n, u, o) {
            Q(
                ...
                t,
                (u = new u(
                    (r = 0 === r.length && 0 == n.byteOffset % o ? n : en(r, n))
                        .buffer,
                    r.byteOffset,
                    r.byteLength / o
                ))
                    ...
                    for (
                        ...
                        if (-1 < y)
                            ((function (e, t, r, n, o, a) {
                                ...
                                p,
                                v,
                                (h = new Uint8Array(i.buffer, b, y - c))
                            ),
                                (c = y),
                                3 === d && c++,
                                (h = l = p = d = 0),
        ...
        ((r.createFromFetch = function (e, t) {
            ...
            (r.createFromReadableStream = function (e, t) {
                return (el((t = ea(t)), e, eo.bind(null, t)), D(t, 0));
            }),
    ...
    (e, t, r) => {
        'use strict';
        t.exports = e.r(686415);
    },
    448163,
    (e, t, r) => {
        'use strict';
        t.exports = e.r(635906);
    },
    643795,
    (e, t, r) => {
        'use strict';
        ...
        function o() {
            return !(function () {
                if ('undefined' == typeof window) {
                    let { workUnitAsyncStorage: t } = e.r(646510),
                        r = t.getStore();
                    if (!r) return !1;
                    switch (r.type) {
                        case 'prerender':
    ...
    (e, t, r) => {
        ...
        for (var u in n)
            Object.defineProperty(r, u, { enumerable: !0, get: n[u] });
        e.r(990341);
        let o = e.r(354866);
        function a(e) {
            return (
    ...
    (e, t, r) => {
        ...
        function l(e) {
            return (
                void 0 !==
                e.split('/').find((e) => a.find((t) => e.startsWith(t)))
            );
        }
        function i(e) {
            let t, r, n;
                ...
                f: [
                    [
                        (function e(t, r, n, u) {
                            ...
                            if ('string' == typeof i)
                                ((o = i),
                                    (l = (0, a.doesStaticSegmentAppearInURL)(
                                        i
                                    )));
                            else {
                                let e = i[0],
                                    t = i[2],
                                    s = (0, a.parseDynamicParamFromURLPart)(
                                        t,
                                        n,
                                        u
                                    );
                                ((o = [
                                    e,
                                    (0, a.getCacheKeyForDynamicParam)(s, r),
                                    t,
                                ]),
                                    (l = !0));
                            }
            ...
            i = (e, t) => {
                let r = e.search,
                    n = (r.startsWith('?') ? r.slice(1) : r)
                        ...
                        .filter(
                            (e) =>
                                e && !e.startsWith(`${a.NEXT_RSC_UNION_QUERY}=`)
                        );
                (t.length > 0
    ...
    (e, t, r) => {
        ...
        async function g(e, t) {
            ...
            (u === c.PrefetchKind.AUTO &&
                (o[l.NEXT_ROUTER_PREFETCH_HEADER] = '1'),
                n && (o[l.NEXT_URL] = n));
            try {
                let t = u
                ...
                if (
                    !i.startsWith(l.RSC_CONTENT_TYPE_HEADER) ||
                    !r.ok ||
                    !r.body
                )
