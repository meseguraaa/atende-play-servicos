    ...
    (t) => {
        ...
        let g = (t) => {
            ...
            let {
                ...
                tf = e.default.useRef(T.duration || V || 4e3),
                ...
                tx = e.default.useMemo(
                    () => C.findIndex((t) => t.toastId === T.id) || 0,
                    [C, T.id]
                ),
                tE = e.default.useMemo(() => {
                    var t;
                    return null != (t = T.closeButton) ? t : I;
                }, [T.closeButton, I]),
                tk = e.default.useMemo(
                    () => T.duration || V || 4e3,
                    [T.duration, V]
                ),
                tT = e.default.useRef(0),
                tN = e.default.useRef(0),
                tS = e.default.useRef(0),
                tM = e.default.useRef(null),
                [tB, tC] = U.split('-'),
                tz = e.default.useMemo(
                    () =>
                        C.reduce((t, e, a) => (a >= tx ? t : t + e.height), 0),
                    [C, tx]
                ),
                tj = (() => {
                ...
                tR = T.invert || k,
                tY = 'loading' === tb;
            ((tN.current = e.default.useMemo(() => tx * X + tz, [tx, tz])),
                e.default.useEffect(() => {
                    tf.current = tk;
                }, [tk]),
                e.default.useEffect(() => {
            ...
            (e.default.useEffect(() => {
                let t;
                if (
                    (!T.promise || 'loading' !== tb) &&
                    T.duration !== 1 / 0 &&
                    'loading' !== T.type
                ) {
                    if (R || S || tj) {
                        if (tS.current < tT.current) {
            ...
            return e.default.createElement(
                'li',
                {
                    ...
                    className: h(
                        ...
                        null == T || null == (a = T.classNames)
                            ? void 0
                            : a.toast,
                        null == F ? void 0 : F.default,
                        null == F ? void 0 : F[tb],
                        null == T || null == (o = T.classNames) ? void 0 : o[tb]
                    ),
                    'data-sonner-toast': '',
                    'data-rich-colors': null != (y = T.richColors) ? y : D,
                    ...
                    onPointerDown: (t) => {
                        2 === t.button ||
                            ...
                            'BUTTON' !== t.target.tagName &&
                                (to(!0),
                                (tM.current = { x: t.clientX, y: t.clientY })));
                    },
                    onPointerUp: () => {
                        var t, e, a, o, r;
                        if (tr || !tv) return;
                        ...
                        if (Math.abs(l) >= 45 || d > 0.11) {
                            (td(tN.current),
                                null == T.onDismiss || T.onDismiss.call(T, T),
                                'x' === W
                                    ? Q(n > 0 ? 'right' : 'left')
                                    : Q(s > 0 ? 'down' : 'up'),
                                tD(),
                              ...
                              onClick:
                                  tY || !tv
                                      ...
                                      : () => {
                                            (tD(),
                                                null == T.onDismiss ||
                                                    T.onDismiss.call(T, T));
                                        },
                              className: h(
                                  null == F ? void 0 : F.closeButton,
                                  null == T || null == (u = T.classNames)
                                      ? void 0
                                      : u.closeButton
                              ),
                          },
                          null != (w = null == K ? void 0 : K.close) ? w : d
                      )
                    : null,
                (tb || T.icon || T.promise) &&
                    null !== T.icon &&
                    ((null == K ? void 0 : K[tb]) !== null || T.icon)
                    ? e.default.createElement(
                          'div',
                          {
                              'data-icon': '',
                              className: h(
                                  ...
                                  null == T || null == (c = T.classNames)
                                      ? void 0
                                      : c.icon
                              ),
                          },
                          T.promise || ('loading' === T.type && !T.icon)
                              ? T.icon ||
                ...
                e.default.isValidElement(T.cancel)
                    ? T.cancel
                    : T.cancel && p(T.cancel)
                      ? e.default.createElement(
                            'button',
                            {
                                ...
                                onClick: (t) => {
                                    !p(T.cancel) ||
                                        (tv &&
                                            (null == T.cancel.onClick ||
                                                T.cancel.onClick.call(
                                                    T.cancel,
                                                    t
                                                ),
                                            tD()));
                      ...
                      : null,
                e.default.isValidElement(T.action)
                    ? T.action
                    : T.action && p(T.action)
                      ? e.default.createElement(
                            'button',
                            {
                                'data-button': !0,
                                'data-action': !0,
                                style: T.actionButtonStyle || A,
                                onClick: (t) => {
                                    !p(T.action) ||
                                        (null == T.action.onClick ||
                                            T.action.onClick.call(T.action, t),
                                        t.defaultPrevented || tD());
                                },
                                className: h(
                                    null == F ? void 0 : F.actionButton,
                                    null == T || null == (v = T.classNames)
                                        ? void 0
                                        : v.actionButton
                                ),
                            },
        ...
        let y = e.default.forwardRef(function (t, o) {
            let {
                    id: r,
                    invert: n,
                ...
                [S, M] = e.default.useState([]),
                B = e.default.useMemo(
                    () =>
                        r
                            ? S.filter((t) => t.toasterId === r)
                                  ...
                                  B.filter(
                                      ...
                                      return e.default.createElement(g, {
                                          ...
                                          closeButtonAriaLabel:
                                              null == x
                                                  ? void 0
                                                  : x.closeButtonAriaLabel,
                                          removeToast: U,
                                          toasts: B.filter(
                                              (t) => t.position == o.position
                                          ),
                                          heights: z.filter(
                                              (t) => t.position == o.position
                                          ),
        ...
        t.s(['Toaster', () => y, 'toast', () => m, 'useSonner', () => v]);
    },
]);
