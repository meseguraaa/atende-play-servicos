((globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
    ...
    {
        otherChunks: [
            'static/chunks/6065f520a430a774.js',
            'static/chunks/1b30902252f7c2a6.js',
            'static/chunks/2451ebe45785848e.js',
            'static/chunks/6f5e3924f7f4782d.js',
            'static/chunks/752ae18234a64839.js',
        ],
        runtimeModuleIds: [200978],
    },
]),
    (() => {
        let e;
        ...
        function c(e, t) {
            (s(e, '__esModule', { value: !0 }),
                i && s(e, i, { value: 'Module' }));
            let r = 0;
            for (; r < t.length; ) {
                let n = t[r++],
                    o = t[r++];
        ...
        ((o.s = function (e, t) {
            ...
            (o.n = function (e, t) {
                let r;
                (r = null != t ? u(this.c, t) : this.m).exports =
                    r.namespaceObject = e;
            }));
        ...
        async function P(e, t, r) {
            ...
            if (s.length > 0) {
                ...
                for (let o of ((n = A(e, t, S(r.path))), i))
                    _.has(o) || _.set(o, n);
            }
                    ...
                    : ((n = void 0),
                      !(function (e, t, r, n) {
                          ...
                          for (; o < e.length; ) {
                              ...
                              for (
                                  ;
                                  n < e.length && 'function' != typeof e[n];
                              )
                                  n++;
                              if (n === e.length)
                                  throw Error(
                ...
                (function (e, t) {
                    ...
                    if ('function' == typeof importScripts)
                        if (x(t));
                            ...
                            throw Error(
                                `can't infer type of chunk from URL ${t} in worker`
                            );
                    else {
                        let e = decodeURI(t);
                        if (x(t))
                            ...
                            throw Error(
                                `can't infer type of chunk from URL ${t}`
                            );
                    }
