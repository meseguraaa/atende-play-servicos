module.exports = [
    ...
    (e) => {
        ...
        async function y(e, r, a) {
            ...
            if (e.protected)
                try {
                    ...
                    h = JSON.parse(d.decoder.decode(r));
                } catch {
                    throw new o.JWSInvalid('JWS Protected Header is invalid');
                }
            if (!(0, s.isDisjoint)(h, e.header))
                throw new o.JWSInvalid(
            ...
            let w = { ...h, ...e.header },
                ...
                m = !0;
            if (f.has('b64') && 'boolean' != typeof (m = h.b64))
                throw new o.JWSInvalid(
            ...
            let S = !1;
            ('function' == typeof r && ((r = await r(h, e)), (S = !0)),
            ...
            let H = await (0, u.normalizeKey)(r, g);
            if (!(await n(g, H, i, b)))
                throw new o.JWSSignatureVerificationFailed();
            if (m)
                try {
                    y = (0, t.decode)(e.payload);
                } catch {
                    throw new o.JWSInvalid(
                ...
                y =
                    'string' == typeof e.payload
                        ...
                        : e.payload;
            let J = { payload: y };
            return (void 0 !== e.protected && (J.protectedHeader = h),
        ...
        async function h(e, t, r) {
            ...
            let c = await y({ payload: i, protected: a, signature: n }, t, r),
    ...
    (e) => {
                ...
                ((0, c.checkKeyType)(m, e, 'sign'),
                    ...
                    this.#t
                        ? ((u = (0, t.encode)(JSON.stringify(this.#t))),
                          (y = (0, s.encode)(u)))
                        : ((u = ''), (y = new Uint8Array())));
                let g = (0, s.concat)(y, (0, s.encode)('.'), i),
        ...
        class w {
            ...
            #i;
            constructor(e = {}) {
                this.#i = new h.JWTClaimsBuilder(e);
            }
            setIssuer(e) {
    ...
    (e) => {
        ...
        var t = e.i(192794),
            r = e.i(968763);
        function a(e, a, i) {
            let n = (0, r.toDate)(e, i?.in);
            return (n.setTime(n.getTime() + a * t.millisecondsInMinute), n);
        }
        e.s(['addMinutes', () => a]);
    },
];

//# sourceMappingURL=%5Broot-of-the-server%5D__583e9f0f._.js.map
