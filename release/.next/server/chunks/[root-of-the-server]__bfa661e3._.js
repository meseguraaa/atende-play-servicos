module.exports = [
    ...
    (e) => {
        ...
        async function u(e, r, a) {
            ...
            if (e.protected)
                try {
                    ...
                    y = JSON.parse(d.decoder.decode(r));
                } catch {
                    throw new o.JWSInvalid('JWS Protected Header is invalid');
                }
            if (!(0, s.isDisjoint)(y, e.header))
                throw new o.JWSInvalid(
            ...
            let w = { ...y, ...e.header },
                ...
                S = !0;
            if (f.has('b64') && 'boolean' != typeof (S = y.b64))
                throw new o.JWSInvalid(
            ...
            let v = !1;
            ('function' == typeof r && ((r = await r(y, e)), (v = !0)),
            ...
            let H = await (0, h.normalizeKey)(r, g);
            if (!(await n(g, H, i, b)))
                throw new o.JWSSignatureVerificationFailed();
            if (S)
                try {
                    u = (0, t.decode)(e.payload);
                } catch {
                    throw new o.JWSInvalid(
                ...
                u =
                    'string' == typeof e.payload
                        ...
                        : e.payload;
            let J = { payload: u };
            return (void 0 !== e.protected && (J.protectedHeader = y),
        ...
        async function y(e, t, r) {
            ...
            let l = await u({ payload: i, protected: a, signature: n }, t, r),
    ...
    (e) => {
        ...
        class h {
            ...
            async sign(e, r) {
                ...
                ((0, l.checkKeyType)(S, e, 'sign'),
                    f
                        ? ((a = (0, t.encode)(this.#e)), (i = (0, s.encode)(a)))
                        : ((i = this.#e), (a = '')),
                    this.#t
                        ? ((h = (0, t.encode)(JSON.stringify(this.#t))),
                          (u = (0, s.encode)(h)))
                        : ((h = ''), (u = new Uint8Array())));
                let g = (0, s.concat)(u, (0, s.encode)('.'), i),
                    m = await (0, p.normalizeKey)(e, S),
                    v = await n(S, m, g),
                    b = { signature: (0, t.encode)(v), payload: a };
                return (
                    this.#r && (b.header = this.#r),
                    this.#t && (b.protected = h),
                    b
                );
            }
        }
        ...
        async function a(e) {
            try {
                ...
                let n = {
                    ...
                    name: a?.name ?? null,
                    unitId: a?.unitId == null ? null : String(a.unitId),
                    canSeeAllUnits:
                        'boolean' == typeof a?.canSeeAllUnits
                            ? a.canSeeAllUnits
                            : void 0,
                    professionalId:
                        a?.professionalId == null
                            ? null
                            : String(a.professionalId),
                };
                if (
                    ((t = String(i || '').toUpperCase()),
                    'PLATFORM_OWNER' === t || 'PLATFORM_STAFF' === t)
                ) {
                    if (!n.sub || !n.email) return null;
                    return n;
                }
                let o = String(a?.tenantSlug ?? '')
                        .trim()
                        .toLowerCase(),
                    d = String(a?.companyId ?? '').trim();
                if (!o || !d) return null;
                return { ...n, tenantSlug: o, companyId: d };
            } catch {
                return null;
            }
        }
        async function i() {
            let e = await (0, t.cookies)(),
                r = e.get('painel_session')?.value;
            return r ? await a(r) : null;
        }
        (e.i(698043), e.s(['getCurrentPainelUser', () => i]));
    },
];
