            ...
            if (w)
                ...
                h =
                    'string' == typeof e.payload
                        ...
                        : e.payload;
            let N = { payload: h };
            return (void 0 !== e.protected && (N.protectedHeader = m),
            void 0 !== e.header && (N.unprotectedHeader = e.header),
            b)
                ? { ...N, key: x }
                : N;
        }
        ...
        class p {
            ...
            async sign(e, r) {
                ...
                let m = { ...this.#t, ...this.#r },
                    ...
                    f = !0;
                if (y.has('b64') && 'boolean' != typeof (f = this.#t.b64))
                    throw new s.JWSInvalid(
                        'The "b64" (base64url-encode payload) Header Parameter must be a boolean'
                    );
                let { alg: w } = m;
    ...
    (e) => {
        ...
        async function R(e) {
            try {
                ...
                let o = new Date(),
                    s = new Date(o.getTime() - 864e5),
                    d = await b.prisma.appointment.findFirst({
                        where: {
                ...
                let l = (function (e) {
                    ...
                    u = (function (e) {
                        ...
                        let s = (r.getTime() - t.getTime()) / 36e5,
                            d = 'number' == typeof n && n > 0,
                            l =
                                'number' == typeof i &&
                                Number.isFinite(i) &&
                                i > 0,
                        ...
                        return {
                            status: 'PENDING',
                            statusLabel: E('PENDING'),
                            canCancel: !0,
                            canReschedule: !d || s >= n,
                            cancellationFeeEligible: c,
                            cancellationFeeNotice: c
                        ...
                        cancelLimitHours: d.service?.cancelLimitHours ?? null,
                        cancelFeePercentage: c,
                    });
                return v.NextResponse.json(
                    {
                        ok: !0,
                        next: {
                            id: d.id,
                            serviceName:
                                d.service?.name ?? d.description ?? 'Serviço',
                            unitName: d.unit?.name ?? 'Unidade',
                            barberName: d.professional?.name ?? 'Profissional',
                            startsAtLabel:
                                ((t = d.scheduleAt),
                                (a = (r = new Date(t)).toLocaleDateString(
                                    'pt-BR',
                                    {
                            ...
                            canCancel: u.canCancel,
                            canReschedule: u.canReschedule,
                            cancellationFeeEligible: u.cancellationFeeEligible,
                            cancellationFeeNotice: u.cancellationFeeNotice,
                            unitId: d.unit?.id ?? null,
                            serviceId: d.service?.id ?? null,
                            barberId: d.professional?.id ?? null,
                        },
                    },
                    { status: 200, headers: x() }
                );
                ...
                return (
                    console.error('[mobile/me/appointments/next] error:', r),
                    v.NextResponse.json(
        ...
        e.s(
            ['GET', () => R, 'OPTIONS', () => H, 'dynamic', 0, 'force-dynamic'],
            735123
        );
        var I = e.i(735123);
        let C = new t.AppRouteRouteModule({
                definition: {
                    ...
                    page: '/api/mobile/me/appointments/next/route',
                    pathname: '/api/mobile/me/appointments/next',
                    filename: 'route',
                    bundlePath: '',
                },
                distDir: '.next',
                relativeProjectDir: '',
                resolvedPagePath:
                    '[project]/src/app/api/mobile/me/appointments/next/route.ts',
        ...
        async function j(e, t, a) {
            ...
            let v = '/api/mobile/me/appointments/next/route';
            v = v.replace(/\/index$/, '') || '/';
            ...
            let {
                ...
                O = !!(H.dynamicRoutes[j] || H.routes[P]),
                U = async () => (
                    (null == R ? void 0 : R.render404)
                        ? await R.render404(e, t, A, !1)
                    ...
                    d = async (n) => {
                        ...
                        let l = async ({ previousCacheEntry: r }) => {
                                try {
                                    ...
                                    let l = q.renderOpts.collectedTags;
                                    if (!O)
                                        return (
                        ...
                        return (
                            (s && O) || u.delete(f.NEXT_CACHE_TAGS_HEADER),
                            !c.cacheControl ||
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c5a2e967._.js.map
