module.exports = [
                ...
                if (t)
                    switch (t.type) {
                        ...
                        case 'prerender-runtime':
                            return (0, i.delayUntilRuntimeStage)(
                                t,
                                b(t.cookies)
                            );
                        case 'private-cache':
                ...
                (super(),
                    (this.headers = new Proxy(e, {
                        get(r, t, n) {
                            ...
                            if (void 0 !== s)
                                return o.ReflectAdapter.get(r, s, n);
                        },
                        set(r, t, n, a) {
                            if ('symbol' == typeof t)
                        ...
                        deleteProperty(r, t) {
                            ...
                            return (
                                void 0 === a ||
                                o.ReflectAdapter.deleteProperty(r, a)
                            );
                        },
                    })));
            }
    ...
    (e, r, t) => {
        ...
        function f() {
            ...
            if (r) {
                ...
                if (r.forceStatic)
                    return h(n.HeadersAdapter.seal(new Headers({})));
                if (t)
                    switch (t.type) {
                        case 'cache': {
                ...
                if (t)
                    switch (t.type) {
                        ...
                        case 'prerender-client':
                            ...
                            throw Object.defineProperty(
                                new l.InvariantError(
                                    `${y} must not be used within a client component. Next.js should be preventing ${y} from being included in client components statically, but did not in this case.`
                                ),
                                '__NEXT_ERROR_CODE',
                                {
                                    value: 'E693',
                        ...
                        case 'prerender-runtime':
                            return (0, s.delayUntilRuntimeStage)(
                                t,
                                h(t.headers)
                            );
                        case 'private-cache':
    ...
    (e, r, t) => {
        ...
        function d() {
            ...
            switch (
                ((!e || !r) && (0, n.throwForMissingRequestStore)('draftMode'),
                r.type)
            ) {
                case 'prerender-runtime':
        ...
        class h {
            ...
            enable() {
                (b('draftMode().enable()', this.enable),
                    null !== this._provider && this._provider.enable());
            }
            disable() {
                (b('draftMode().disable()', this.disable),
    ...
    387148,
    (e, r, t) => {
        ((r.exports.cookies = e.r(84037).cookies),
            (r.exports.headers = e.r(520493).headers),
            (r.exports.draftMode = e.r(100989).draftMode));
    },
];

//# sourceMappingURL=c2dd8_next_8c062a70._.js.map
