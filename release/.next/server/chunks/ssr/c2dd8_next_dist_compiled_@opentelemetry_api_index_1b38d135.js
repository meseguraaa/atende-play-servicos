                ...
                x = {
                            ...
                            constructor() {
                                ...
                                ((b.setLogger = (
                                    ...
                                    if (j && !c.suppressOverrideMessage) {
                                        ...
                                        (j.warn(
                                            `Current logger will be overwritten from ${a}`
                                        ),
                                            k.warn(
                                                `Current logger will overwrite one already registered from ${a}`
                                            ));
                                    }
                                    return (0, g.registerGlobal)(
                                        'diag',
                                        k,
                                        b,
                                        !0
                    ...
                    653: (a, b, c) => {
                        ...
                        class h {
                            ...
                            getMeterProvider() {
                                return (
                                    (0, e.getGlobal)(g) || d.NOOP_METER_PROVIDER
                                );
                            }
                            getMeter(a, b, c) {
                    ...
                    56: (a, b, c) => {
                        ...
                        b.DiagComponentLogger = class {
                            constructor(a) {
                                this._namespace =
                                    a.namespace || 'DiagComponentLogger';
                            }
                            debug(...a) {
                    ...
                    957: (a, b) => {
                        ...
                        (Object.defineProperty(b, '__esModule', { value: !0 }),
                            ...
                            ((c = b.DiagLogLevel || (b.DiagLogLevel = {}))[
                                (c.NONE = 0)
                            ] = 'NONE'),
                            (c[(c.ERROR = 30)] = 'ERROR'),
                            (c[(c.WARN = 50)] = 'WARN'),
                    ...
                    130: (a, b, c) => {
                        (Object.defineProperty(b, '__esModule', { value: !0 }),
                            (b.isCompatible = b._makeCompatibilityCheck =
                                void 0));
                        let d = c(521),
                            e = /^(\d+)\.(\d+)\.(\d+)(-(.+))?$/;
                        function f(a) {
                            ...
                            return function (a) {
                                ...
                                if (null != h.prerelease || f.major !== h.major)
                                    return g(a);
                                if (0 === f.major)
                                    return f.minor === h.minor &&
                                        f.patch <= h.patch
                                        ? (b.add(a), !0)
                                        : g(a);
                                return f.minor <= h.minor
                    ...
                    660: (a, b, c) => {
                        (Object.defineProperty(b, '__esModule', { value: !0 }),
                            (b.NOOP_METER_PROVIDER = b.NoopMeterProvider =
                                void 0));
                        let d = c(102);
                        class e {
                            getMeter(a, b, c) {
                    ...
                    939: (a, b, c) => {
                        (Object.defineProperty(b, '__esModule', { value: !0 }),
                            ...
                            (b.propagation =
                                c(181).PropagationAPI.getInstance()));
                    },
                    874: (a, b) => {
                        (Object.defineProperty(b, '__esModule', { value: !0 }),
                    ...
                    194: (a, b) => {
                        (Object.defineProperty(b, '__esModule', { value: !0 }),
                            (b.defaultTextMapSetter = b.defaultTextMapGetter =
                                void 0),
                    ...
                    125: (a, b, c) => {
                        ...
                        b.ProxyTracer = class {
                            ...
                            _getTracer() {
                                ...
                                return a
                                    ? ((this._delegate = a), this._delegate)
                                    : d;
                            }
                        };
                    },
                    846: (a, b, c) => {
                        ...
                        b.ProxyTracerProvider = class {
                            getTracer(a, b, c) {
                                var e;
                                return null !=
                                    (e = this.getDelegateTracer(a, b, c))
                                    ? e
                    ...
                    996: (a, b) => {
                        ...
                        (Object.defineProperty(b, '__esModule', { value: !0 }),
                            ...
                            ((c =
                                b.SamplingDecision ||
                                (b.SamplingDecision = {}))[(c.NOT_RECORD = 0)] =
                                'NOT_RECORD'),
                            (c[(c.RECORD = 1)] = 'RECORD'),
                            (c[(c.RECORD_AND_SAMPLED = 2)] =
                                'RECORD_AND_SAMPLED'));
                    },
                    607: (a, b, c) => {
                        (Object.defineProperty(b, '__esModule', { value: !0 }),
...
//# sourceMappingURL=c2dd8_next_dist_compiled_%40opentelemetry_api_index_1b38d135.js.map
