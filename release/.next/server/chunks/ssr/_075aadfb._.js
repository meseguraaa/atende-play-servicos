module.exports = [
    ...
    (a) => {
        ...
        let I = [
                                        ...
                                        'config',
                                        {
                                            children: [
                                                ...
                                                {},
                                                {
                                                    ...
                                                    page: [
                                                        () => a.r(190712),
                                                        '[project]/src/app/admin/client-level/config/page.tsx',
                                                    ],
                                                },
                                            ],
                                        },
            ...
            K = new d.AppPageRouteModule({
                definition: {
                    ...
                    page: '/admin/client-level/config/page',
                    pathname: '/admin/client-level/config',
                    bundlePath: '',
                    filename: '',
                    appPaths: [],
                },
        ...
        async function L(a, b, c) {
            ...
            let M = '/admin/client-level/config/page';
            M = M.replace(/\/index$/, '') || '/';
...
//# sourceMappingURL=_075aadfb._.js.map
