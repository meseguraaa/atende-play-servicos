module.exports = [
    ...
    (a) => {
        ...
        let b = (0, a.i(976286).registerClientReference)(
            function () {
                throw Error(
                    "Attempted to call ProfessionalRow() from the server but ProfessionalRow is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component."
                );
            },
            '[project]/src/components/admin/professionals/professional-row/professional-row.tsx <module evaluation>',
            'ProfessionalRow'
        );
        a.s(['ProfessionalRow', 0, b]);
    },
    281533,
    (a) => {
        'use strict';
    ...
    (a) => {
        ...
        let b = (0, a.i(976286).registerClientReference)(
            function () {
                throw Error(
                    "Attempted to call ProfessionalNewDialog() from the server but ProfessionalNewDialog is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component."
                );
            },
    ...
    (a) => {
        ...
        var b = a.i(623127),
            ...
            f = a.i(976520),
            g = a.i(915521);
        let h = ['Dom', 'Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'Sáb'];
        async function i() {
            let a = String(
                (await (0, d.requireAdminForModule)('PROFESSIONALS')).companyId
            );
            if (!a)
                return (0, b.jsx)('div', {
                    ...
                    children: (0, b.jsx)('div', {
                        ...
                        children: (0, b.jsx)('p', {
                            ...
                            children: 'Sessão inválida (companyId ausente).',
                        }),
                    }),
                });
            let i = await c.prisma.unit.findMany({
                    where: { companyId: a },
                ...
                j = (
                    ...
                    let b,
                        ...
                        f = a.weeklyAvailabilities.map((a) => ({
                            weekday: a.weekday,
                            isActive: a.isActive,
                        ...
                        i = (function (a) {
                            ...
                            let b = a.length,
                                c = a.reduce((a, b) => a + (b.rating ?? 0), 0),
                                d = new Map();
                            for (let a = 1; a <= 5; a++) d.set(a, 0);
                            for (let b of a) {
                                let a = Math.max(
                                    1,
                                    Math.min(5, Number(b.rating ?? 0))
                                );
                                d.set(a, (d.get(a) ?? 0) + 1);
                            }
                            let e = Array.from(d.entries())
                                    .map(([a, b]) => ({ rating: a, count: b }))
                                    .sort((a, b) => b.rating - a.rating),
                                f = new Map();
                            for (let b of a)
                                for (let a of b.tags ?? []) {
                                    let b = String(a?.tag?.label ?? '').trim();
                                    b && f.set(b, (f.get(b) ?? 0) + 1);
                                }
                            return {
                                avgRating: b > 0 ? c / b : 0,
                                totalReviews: b,
                                ratingsCount: e,
                                topTags: Array.from(f.entries())
                                    .map(([a, b]) => ({ label: a, count: b }))
                                    .sort((a, b) =>
                                        b.count !== a.count
                                            ? b.count - a.count
                    ...
                    return {
                        ...
                        imageUrl: a.imageUrl ?? a.user?.image ?? null,
                        selectedUnitIds: d,
                        linkedUnits: e,
                        weeklyScheduleLabel:
                            0 ===
                            (b = f
                                .filter(
                                    (a) => a.isActive && a.intervals.length > 0
                                )
                                .sort((a, b) => a.weekday - b.weekday)).length
                                ? 'Sem escala semanal'
                                : b.length <= 3
                                  ? b
                                        .map((a) => {
                                        ...
                                        .join(' • ')
                                  : `${b.length} dias com escala`,
                        exceptionsLabel: (function (a) {
                            if (0 === a.length) return 'Sem exceções';
                            let b = a.filter(
                                    (a) => 'DAY_OFF' === a.type
                                ).length,
                                c = a.filter((a) => 'CUSTOM' === a.type).length,
                                d = [];
                            return (
                                b > 0 &&
                                    d.push(
                                ...
                                c > 0 &&
                                    d.push(
                                        1 === c
                                            ? '1 ajuste de horário'
                                            : `${c} ajustes de hor\xe1rio`
                                    ),
                                d.join(' • ') || 'Exceções cadastradas'
                            );
                        })(g),
                        weeklyAvailabilities: f,
                        dailyAvailabilities: g,
                        reviewStats: i,
                    };
                }),
                k = j.filter((a) => a.isActive),
                l = j.filter((a) => !a.isActive);
            return (0, b.jsxs)('div', {
                className: 'space-y-8 max-w-7xl',
                children: [
                    (0, b.jsxs)('header', {
                            ...
                            (0, b.jsxs)('div', {
                                children: [
                                    ...
                                    (0, b.jsx)('p', {
                                        ...
                                        children:
                                            'Veja a disponibilidade, reputação e as unidades vinculadas de cada profissional.',
                                    }),
                                ],
                            }),
                            (0, b.jsx)(g.ProfessionalNewDialog, { units: i }),
                        ],
                    }),
                    (0, b.jsxs)('section', {
                        className: 'space-y-4',
                            ...
                            (0, b.jsx)(e.Accordion, {
                                ...
                                children:
                                    0 === k.length
                                        ? (0, b.jsx)('p', {
                                              className:
                                                  'text-paragraph-small text-content-secondary px-2',
                                              children:
                    ...
                    (0, b.jsxs)('section', {
                        ...
                        children: [
                            (0, b.jsx)('h2', {
                                className:
                                    'text-paragraph-medium text-content-primary',
                                children: 'Profissionais inativos',
                            }),
                            (0, b.jsx)(e.Accordion, {
                                type: 'single',
                                collapsible: !0,
