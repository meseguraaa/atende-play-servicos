module.exports = [
            ...
            let b = new Proxy(a.mutableCookies, {
                get(c, d, e) {
                    switch (d) {
                        ...
                        case 'set':
                            return function (...d) {
                                return (q(a, 'cookies().set'), c.set(...d), b);
                            };
                        default:
    ...
    (a, b, c) => {
        ...
        function n() {
            ...
            if (b) {
                ...
                if (b.forceStatic)
                    return p(
                        d.RequestCookiesAdapter.seal(
                            new e.RequestCookies(new Headers({}))
                        )
                    );
                ...
                if (c)
                    switch (c.type) {
                        ...
                        case 'prerender-ppr':
                            return (0, h.postponeWithTracking)(
                                b.route,
                                a,
                                c.dynamicTracking
                            );
                        case 'prerender-legacy':
                            return (0, h.throwToInterruptStaticGeneration)(
                                a,
                                b,
                                c
                            );
                ...
                (super(),
                    (this.headers = new Proxy(a, {
                        ...
                        deleteProperty(b, c) {
                            ...
                            return (
                                void 0 === e ||
                                f.ReflectAdapter.deleteProperty(b, e)
                            );
                        },
                    })));
            }
            ...
            if (b) {
                ...
                if (c)
                    switch (c.type) {
                        ...
                        case 'prerender-ppr':
                            return (0, g.postponeWithTracking)(
                                b.route,
                                a,
                                c.dynamicTracking
                            );
                        case 'prerender-legacy':
                            return (0, g.throwToInterruptStaticGeneration)(
                                a,
                                b,
                                c
                            );
                        case 'prerender-runtime':
                            return (0, g.delayUntilRuntimeStage)(
                                c,
                                o(c.headers)
                            );
                        case 'private-cache':
    ...
    (a, b, c) => {
        ...
        function k() {
            ...
            switch (
                ((!a || !b) && (0, d.throwForMissingRequestStore)('draftMode'),
                b.type)
            ) {
                case 'prerender-runtime':
    ...
    169513,
    (a, b, c) => {
        ((b.exports.cookies = a.r(177534).cookies),
            (b.exports.headers = a.r(618170).headers),
            (b.exports.draftMode = a.r(953827).draftMode));
    },
];

//# sourceMappingURL=c2dd8_next_a6332d95._.js.map
