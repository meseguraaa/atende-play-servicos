module.exports = [
    ...
    (a) => {
        ...
        let b = (0, a.i(976286).registerClientReference)(
            function () {
                throw Error(
                    "Attempted to call the default export of [project]/src/app/admin/setting/admin-settings-client.tsx <module evaluation> from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component."
                );
            },
    ...
    (a) => {
        ...
        let b = (0, a.i(976286).registerClientReference)(
            function () {
                throw Error(
                    "Attempted to call the default export of [project]/src/app/admin/setting/admin-settings-client.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component."
                );
            },
    ...
    (a) => {
        ...
        async function e() {
            return (
                await (0, c.requireAdminForModule)('SETTINGS'),
                (0, b.jsx)(d.default, {})
            );
        }
        a.s([
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a8a13e09._.js.map
