module.exports = [
    ...
    (a) => {
        ...
        function h({
            ...
            let k = (0, d.useRouter)(),
                l = (0, d.usePathname)(),
                m = (0, d.useSearchParams)(),
                n = (0, c.useMemo)(() => String(g(a)), [a]);
            return (0, b.jsxs)('div', {
                className: 'space-y-2',
                children: [
                    (0, b.jsx)('p', {
                    ...
                    (0, b.jsxs)(e.Select, {
                        ...
                        onValueChange: function (a) {
                            let b = Number(a),
                                c = g(Number.isFinite(b) ? b : null),
                                d = new URLSearchParams(m?.toString());
                            d.set(h, String(c));
                            let e = d.toString();
                            k.push(e ? `${l}?${e}` : l);
                        },
        ...
        a.s(['RetentionWindowFilter', () => h]);
    },
];

//# sourceMappingURL=src_components_admin_reports_faf02fec._.js.map
