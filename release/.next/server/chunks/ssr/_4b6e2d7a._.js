module.exports = [
    ...
    (a) => {
        ...
        let I = [
                                        ...
                                        'funnel',
                                        {
                                            children: [
                                                ...
                                                {},
                                                {
                                                    ...
                                                    page: [
                                                        () => a.r(492564),
                                                        '[project]/src/app/admin/report/funnel/page.tsx',
                                                    ],
                                                },
                                            ],
                                        },
            ...
            K = new d.AppPageRouteModule({
                definition: {
                    ...
                    page: '/admin/report/funnel/page',
                    pathname: '/admin/report/funnel',
                    bundlePath: '',
                    filename: '',
                    appPaths: [],
                },
        ...
        async function L(a, b, c) {
            ...
            let M = '/admin/report/funnel/page';
            M = M.replace(/\/index$/, '') || '/';
...
//# sourceMappingURL=_4b6e2d7a._.js.map
