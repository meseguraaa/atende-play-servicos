    ...
    (e) => {
        ...
        async function h(e, r, a) {
            ...
            let w = { ...y, ...e.header },
                ...
                g = !0;
            if (f.has('b64') && 'boolean' != typeof (g = y.b64))
                throw new o.JWSInvalid(
            ...
            let H = await (0, u.normalizeKey)(r, S);
            if (!(await n(S, H, i, b)))
                ...
                ((0, l.checkKeyType)(g, e, 'sign'),
                    ...
                    this.#t
                        ? ((u = (0, t.encode)(JSON.stringify(this.#t))),
                          (h = (0, s.encode)(u)))
                        : ((u = ''), (h = new Uint8Array())));
                let S = (0, s.concat)(h, (0, s.encode)('.'), i),
                    m = await (0, p.normalizeKey)(e, g),
                    v = await n(g, m, S),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3ac9775d._.js.map
