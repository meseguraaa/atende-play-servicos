    ...
    (e) => {
            ...
            try {
                ...
                if (i && i !== a)
                    return v.NextResponse.json(
                        ...
                        {
                            status: 400,
                            headers: { ...r, 'Cache-Control': 'no-store' },
                        }
                    );
                let { id: o } = await t.params,
                    s = String(o ?? '').trim();
                if (!s)
                    return v.NextResponse.json(
                        { error: 'missing_id' },
                ...
                let d = await b.prisma.partner.findFirst({
                    where: {
                        id: s,
                        isActive: !0,
                        OR: [
                ...
                let l = {
                        ...
                        discountPct:
                            'number' == typeof d.discountPct
                                ? d.discountPct
                                : Number(d.discountPct ?? 0),
                        description: d.description ?? null,
                        rules: d.rules ?? null,
                        ctaUrl: d.ctaUrl,
                        ctaLabel: d.ctaLabel ?? 'Ativar cashback e ir pra loja',
                    },
                    c = v.NextResponse.json(
                        { ok: !0, partner: l, item: l },
                        {
                            status: 200,
                            headers: { ...r, 'Cache-Control': 'no-store' },
                        }
                    );
                return (c.headers.set('x-company-id', a), c);
            } catch (t) {
                ...
                return (
                    console.error('[mobile partner detail] error:', t),
                    v.NextResponse.json(
                        { error: 'server_error' },
        ...
        let W = new t.AppRouteRouteModule({
                definition: {
                    ...
                    page: '/api/mobile/partners/[id]/route',
                    pathname: '/api/mobile/partners/[id]',
                    filename: 'route',
                    bundlePath: '',
                },
                distDir: '.next',
                relativeProjectDir: '',
                resolvedPagePath:
                    '[project]/src/app/api/mobile/partners/[id]/route.ts',
        ...
        async function j(e, t, a) {
            ...
            let v = '/api/mobile/partners/[id]/route';
            v = v.replace(/\/index$/, '') || '/';
            let b = await W.prepare(e, t, {
                srcPage: v,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5dddfc45._.js.map
