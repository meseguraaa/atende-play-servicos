...
export default async function AdminReportsRetentionPage({
    ...
    // ===== Profissionais (já respeita unidade selecionada)
        ...
        <div className="space-y-6 max-w-7xl">
            ...
            <section className="grid gap-4 md:grid-cols-4">
                ...
                <div className="rounded-xl border border-border-primary bg-background-tertiary px-4 py-3">
                    ...
                    <p className="mt-1 text-[11px] text-content-tertiary">
                        Clientes novos que ainda não voltaram em {windowDays}{' '}
                        dias
                    </p>
                    <p className="mt-1 text-[11px] text-content-tertiary">
                        vs {compareLabel(compareMode)}:{' '}
                ...
                <div className="flex items-start justify-between gap-3">
                    <div>
                        ...
                        <p className="text-paragraph-small text-content-tertiary">
                            Mostra em qual dia os clientes novos voltam após a
                            1ª visita (e o acumulado até aquele dia).
                        </p>
                    </div>
                ...
                {baseKpis.cohortSize === 0 ? (
                    ...
                    <div className="mt-4 overflow-x-auto">
                        ...
                        <p className="mt-2 text-[11px] text-content-tertiary">
                            Leitura rápida: o “acumulado” é a retenção crescendo
                ...
                <div className="rounded-xl border border-border-primary bg-background-tertiary p-4">
                    ...
                    {unitAvgRow.cohortSize === 0 ? (
                        ...
                        <div className="mt-4 overflow-x-auto">
                            ...
                            <p className="mt-2 text-[11px] text-content-tertiary">
                                Como ler: “Clientes novos” são os que fizeram a
                                1ª visita no mês. A retenção mede quantos
                                voltaram em até {windowDays} dias.
                            </p>
                        </div>
                    )}
                </div>
                ...
                <div className="rounded-xl border border-border-primary bg-background-tertiary p-4">
                    ...
                    {baseKpis.cohortSize === 0 ? (
                        ...
                        <div className="mt-4 overflow-x-auto">
                            ...
                            <p className="mt-2 text-[11px] text-content-tertiary">
                                Dica: comece por “Passou de {windowDays} dias”.
                                Esses são os mais urgentes.
                            </p>
                        </div>
                    )}
                </div>
